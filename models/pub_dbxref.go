...
func (q pubDbxrefQuery) One() (*PubDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for pub_dbxref")
	}
...
func (q pubDbxrefQuery) All() (PubDbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to PubDbxref slice")
	}
...
func (q pubDbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count pub_dbxref rows")
	}
...
func (q pubDbxrefQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if pub_dbxref exists")
	}
...
func FindPubDbxref(exec boil.Executor, pubDbxrefID int, selectCols ...string) (*PubDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from pub_dbxref")
	}
...
func (o *PubDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no pub_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into pub_dbxref")
	}
...
func (o *PubDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update pub_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update pub_dbxref row")
	}
...
func (q pubDbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for pub_dbxref")
	}
...
func (o PubDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in pubDbxref slice")
	}
...
func (o *PubDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no pub_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert pub_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for pub_dbxref")
	}
...
func (o *PubDbxref) DeleteG() error {
	if o == nil {
		return errors.New("models: no PubDbxref provided for deletion")
	}
...
func (o *PubDbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no PubDbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from pub_dbxref")
	}
...
func (q pubDbxrefQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no pubDbxrefQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from pub_dbxref")
	}
...
func (o PubDbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no PubDbxref slice provided for delete all")
	}
...
func (o PubDbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from pubDbxref slice")
	}
...
func (o *PubDbxref) ReloadG() error {
	if o == nil {
		return errors.New("models: no PubDbxref provided for reload")
	}
...
func (o *PubDbxrefSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PubDbxrefSlice provided for reload all")
	}
...
func (o *PubDbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PubDbxrefSlice")
	}
...
func PubDbxrefExists(exec boil.Executor, pubDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if pub_dbxref exists")
	}
