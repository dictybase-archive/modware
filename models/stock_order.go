...
func (q stockOrderQuery) One() (*StockOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for stock_order")
	}
...
func (q stockOrderQuery) All() (StockOrderSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to StockOrder slice")
	}
...
func (q stockOrderQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count stock_order rows")
	}
...
func (q stockOrderQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if stock_order exists")
	}
...
func FindStockOrder(exec boil.Executor, stockOrderID int, selectCols ...string) (*StockOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from stock_order")
	}
...
func (o *StockOrder) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_order provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into stock_order")
	}
...
func (o *StockOrder) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update stock_order, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update stock_order row")
	}
...
func (q stockOrderQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for stock_order")
	}
...
func (o StockOrderSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in stockOrder slice")
	}
...
func (o *StockOrder) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_order provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert stock_order, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for stock_order")
	}
...
func (o *StockOrder) DeleteG() error {
	if o == nil {
		return errors.New("models: no StockOrder provided for deletion")
	}
...
func (o *StockOrder) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no StockOrder provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from stock_order")
	}
...
func (q stockOrderQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no stockOrderQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stock_order")
	}
...
func (o StockOrderSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no StockOrder slice provided for delete all")
	}
...
func (o StockOrderSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stockOrder slice")
	}
...
func (o *StockOrder) ReloadG() error {
	if o == nil {
		return errors.New("models: no StockOrder provided for reload")
	}
...
func (o *StockOrderSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StockOrderSlice provided for reload all")
	}
...
func (o *StockOrderSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in StockOrderSlice")
	}
...
func StockOrderExists(exec boil.Executor, stockOrderID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if stock_order exists")
	}
