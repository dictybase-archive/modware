...
func (q dbxrefpropQuery) One() (*Dbxrefprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for dbxrefprop")
	}
...
func (q dbxrefpropQuery) All() (DbxrefpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Dbxrefprop slice")
	}
...
func (q dbxrefpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count dbxrefprop rows")
	}
...
func (q dbxrefpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if dbxrefprop exists")
	}
...
func FindDbxrefprop(exec boil.Executor, dbxrefpropID int, selectCols ...string) (*Dbxrefprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from dbxrefprop")
	}
...
func (o *Dbxrefprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no dbxrefprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into dbxrefprop")
	}
...
func (o *Dbxrefprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update dbxrefprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update dbxrefprop row")
	}
...
func (q dbxrefpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for dbxrefprop")
	}
...
func (o DbxrefpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in dbxrefprop slice")
	}
...
func (o *Dbxrefprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no dbxrefprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert dbxrefprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for dbxrefprop")
	}
...
func (o *Dbxrefprop) DeleteG() error {
	if o == nil {
		return errors.New("models: no Dbxrefprop provided for deletion")
	}
...
func (o *Dbxrefprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Dbxrefprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from dbxrefprop")
	}
...
func (q dbxrefpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no dbxrefpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from dbxrefprop")
	}
...
func (o DbxrefpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Dbxrefprop slice provided for delete all")
	}
...
func (o DbxrefpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from dbxrefprop slice")
	}
...
func (o *Dbxrefprop) ReloadG() error {
	if o == nil {
		return errors.New("models: no Dbxrefprop provided for reload")
	}
...
func (o *DbxrefpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty DbxrefpropSlice provided for reload all")
	}
...
func (o *DbxrefpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in DbxrefpropSlice")
	}
...
func DbxrefpropExists(exec boil.Executor, dbxrefpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if dbxrefprop exists")
	}
