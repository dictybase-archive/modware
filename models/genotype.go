...
func (q genotypeQuery) One() (*Genotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for genotype")
	}
...
func (q genotypeQuery) All() (GenotypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Genotype slice")
	}
...
func (q genotypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count genotype rows")
	}
...
func (q genotypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if genotype exists")
	}
...
func FindGenotype(exec boil.Executor, genotypeID int, selectCols ...string) (*Genotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from genotype")
	}
...
func (o *Genotype) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no genotype provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into genotype")
	}
...
func (o *Genotype) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update genotype, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update genotype row")
	}
...
func (q genotypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for genotype")
	}
...
func (o GenotypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in genotype slice")
	}
...
func (o *Genotype) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no genotype provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert genotype, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for genotype")
	}
...
func (o *Genotype) DeleteG() error {
	if o == nil {
		return errors.New("models: no Genotype provided for deletion")
	}
...
func (o *Genotype) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Genotype provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from genotype")
	}
...
func (q genotypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no genotypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from genotype")
	}
...
func (o GenotypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Genotype slice provided for delete all")
	}
...
func (o GenotypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from genotype slice")
	}
...
func (o *Genotype) ReloadG() error {
	if o == nil {
		return errors.New("models: no Genotype provided for reload")
	}
...
func (o *GenotypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty GenotypeSlice provided for reload all")
	}
...
func (o *GenotypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in GenotypeSlice")
	}
...
func GenotypeExists(exec boil.Executor, genotypeID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if genotype exists")
	}
