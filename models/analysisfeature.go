...
func (q analysisfeatureQuery) One() (*Analysisfeature, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for analysisfeature")
	}
...
func (q analysisfeatureQuery) All() (AnalysisfeatureSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Analysisfeature slice")
	}
...
func (q analysisfeatureQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count analysisfeature rows")
	}
...
func (q analysisfeatureQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if analysisfeature exists")
	}
...
func FindAnalysisfeature(exec boil.Executor, analysisfeatureID int, selectCols ...string) (*Analysisfeature, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from analysisfeature")
	}
...
func (o *Analysisfeature) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisfeature provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into analysisfeature")
	}
...
func (o *Analysisfeature) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update analysisfeature, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update analysisfeature row")
	}
...
func (q analysisfeatureQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for analysisfeature")
	}
...
func (o AnalysisfeatureSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in analysisfeature slice")
	}
...
func (o *Analysisfeature) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisfeature provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert analysisfeature, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for analysisfeature")
	}
...
func (o *Analysisfeature) DeleteG() error {
	if o == nil {
		return errors.New("models: no Analysisfeature provided for deletion")
	}
...
func (o *Analysisfeature) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Analysisfeature provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from analysisfeature")
	}
...
func (q analysisfeatureQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no analysisfeatureQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisfeature")
	}
...
func (o AnalysisfeatureSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Analysisfeature slice provided for delete all")
	}
...
func (o AnalysisfeatureSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisfeature slice")
	}
...
func (o *Analysisfeature) ReloadG() error {
	if o == nil {
		return errors.New("models: no Analysisfeature provided for reload")
	}
...
func (o *AnalysisfeatureSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AnalysisfeatureSlice provided for reload all")
	}
...
func (o *AnalysisfeatureSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in AnalysisfeatureSlice")
	}
...
func AnalysisfeatureExists(exec boil.Executor, analysisfeatureID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if analysisfeature exists")
	}
