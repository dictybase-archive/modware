...
func (q featurePhenotypeQuery) One() (*FeaturePhenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_phenotype")
	}
...
func (q featurePhenotypeQuery) All() (FeaturePhenotypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeaturePhenotype slice")
	}
...
func (q featurePhenotypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_phenotype rows")
	}
...
func (q featurePhenotypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_phenotype exists")
	}
...
func FindFeaturePhenotype(exec boil.Executor, featurePhenotypeID int, selectCols ...string) (*FeaturePhenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_phenotype")
	}
...
func (o *FeaturePhenotype) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_phenotype provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_phenotype")
	}
...
func (o *FeaturePhenotype) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_phenotype, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_phenotype row")
	}
...
func (q featurePhenotypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_phenotype")
	}
...
func (o FeaturePhenotypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featurePhenotype slice")
	}
...
func (o *FeaturePhenotype) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_phenotype provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_phenotype, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_phenotype")
	}
...
func (o *FeaturePhenotype) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeaturePhenotype provided for deletion")
	}
...
func (o *FeaturePhenotype) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeaturePhenotype provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_phenotype")
	}
...
func (q featurePhenotypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featurePhenotypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_phenotype")
	}
...
func (o FeaturePhenotypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeaturePhenotype slice provided for delete all")
	}
...
func (o FeaturePhenotypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featurePhenotype slice")
	}
...
func (o *FeaturePhenotype) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeaturePhenotype provided for reload")
	}
...
func (o *FeaturePhenotypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeaturePhenotypeSlice provided for reload all")
	}
...
func (o *FeaturePhenotypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeaturePhenotypeSlice")
	}
...
func FeaturePhenotypeExists(exec boil.Executor, featurePhenotypeID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_phenotype exists")
	}
