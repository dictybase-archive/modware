...
func (q pubauthorQuery) One() (*Pubauthor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for pubauthor")
	}
...
func (q pubauthorQuery) All() (PubauthorSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Pubauthor slice")
	}
...
func (q pubauthorQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count pubauthor rows")
	}
...
func (q pubauthorQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if pubauthor exists")
	}
...
func FindPubauthor(exec boil.Executor, pubauthorID int, selectCols ...string) (*Pubauthor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from pubauthor")
	}
...
func (o *Pubauthor) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no pubauthor provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into pubauthor")
	}
...
func (o *Pubauthor) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update pubauthor, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update pubauthor row")
	}
...
func (q pubauthorQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for pubauthor")
	}
...
func (o PubauthorSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in pubauthor slice")
	}
...
func (o *Pubauthor) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no pubauthor provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert pubauthor, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for pubauthor")
	}
...
func (o *Pubauthor) DeleteG() error {
	if o == nil {
		return errors.New("models: no Pubauthor provided for deletion")
	}
...
func (o *Pubauthor) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Pubauthor provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from pubauthor")
	}
...
func (q pubauthorQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no pubauthorQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from pubauthor")
	}
...
func (o PubauthorSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Pubauthor slice provided for delete all")
	}
...
func (o PubauthorSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from pubauthor slice")
	}
...
func (o *Pubauthor) ReloadG() error {
	if o == nil {
		return errors.New("models: no Pubauthor provided for reload")
	}
...
func (o *PubauthorSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PubauthorSlice provided for reload all")
	}
...
func (o *PubauthorSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PubauthorSlice")
	}
...
func PubauthorExists(exec boil.Executor, pubauthorID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if pubauthor exists")
	}
