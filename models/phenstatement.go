...
func (q phenstatementQuery) One() (*Phenstatement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for phenstatement")
	}
...
func (q phenstatementQuery) All() (PhenstatementSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Phenstatement slice")
	}
...
func (q phenstatementQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count phenstatement rows")
	}
...
func (q phenstatementQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if phenstatement exists")
	}
...
func FindPhenstatement(exec boil.Executor, phenstatementID int, selectCols ...string) (*Phenstatement, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from phenstatement")
	}
...
func (o *Phenstatement) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenstatement provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into phenstatement")
	}
...
func (o *Phenstatement) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update phenstatement, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update phenstatement row")
	}
...
func (q phenstatementQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for phenstatement")
	}
...
func (o PhenstatementSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in phenstatement slice")
	}
...
func (o *Phenstatement) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenstatement provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert phenstatement, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for phenstatement")
	}
...
func (o *Phenstatement) DeleteG() error {
	if o == nil {
		return errors.New("models: no Phenstatement provided for deletion")
	}
...
func (o *Phenstatement) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Phenstatement provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from phenstatement")
	}
...
func (q phenstatementQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no phenstatementQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenstatement")
	}
...
func (o PhenstatementSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Phenstatement slice provided for delete all")
	}
...
func (o PhenstatementSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenstatement slice")
	}
...
func (o *Phenstatement) ReloadG() error {
	if o == nil {
		return errors.New("models: no Phenstatement provided for reload")
	}
...
func (o *PhenstatementSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PhenstatementSlice provided for reload all")
	}
...
func (o *PhenstatementSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PhenstatementSlice")
	}
...
func PhenstatementExists(exec boil.Executor, phenstatementID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if phenstatement exists")
	}
