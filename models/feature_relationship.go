...
func (q featureRelationshipQuery) One() (*FeatureRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_relationship")
	}
...
func (q featureRelationshipQuery) All() (FeatureRelationshipSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeatureRelationship slice")
	}
...
func (q featureRelationshipQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_relationship rows")
	}
...
func (q featureRelationshipQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_relationship exists")
	}
...
func FindFeatureRelationship(exec boil.Executor, featureRelationshipID int, selectCols ...string) (*FeatureRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_relationship")
	}
...
func (o *FeatureRelationship) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_relationship provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_relationship")
	}
...
func (o *FeatureRelationship) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_relationship, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_relationship row")
	}
...
func (q featureRelationshipQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_relationship")
	}
...
func (o FeatureRelationshipSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureRelationship slice")
	}
...
func (o *FeatureRelationship) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_relationship provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_relationship, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_relationship")
	}
...
func (o *FeatureRelationship) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationship provided for deletion")
	}
...
func (o *FeatureRelationship) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeatureRelationship provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_relationship")
	}
...
func (q featureRelationshipQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featureRelationshipQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_relationship")
	}
...
func (o FeatureRelationshipSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationship slice provided for delete all")
	}
...
func (o FeatureRelationshipSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureRelationship slice")
	}
...
func (o *FeatureRelationship) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationship provided for reload")
	}
...
func (o *FeatureRelationshipSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeatureRelationshipSlice provided for reload all")
	}
...
func (o *FeatureRelationshipSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeatureRelationshipSlice")
	}
...
func FeatureRelationshipExists(exec boil.Executor, featureRelationshipID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_relationship exists")
	}
