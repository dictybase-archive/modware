...
func (o *AuthProvider) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update auth_provider, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update auth_provider row")
	}
...
func (q authProviderQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for auth_provider")
	}
...
func (o AuthProviderSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in authProvider slice")
	}
...
func (o *AuthProvider) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for auth_provider")
	}
...
func (o *AuthProvider) DeleteG() error {
	if o == nil {
		return errors.New("models: no AuthProvider provided for deletion")
	}
...
func (o *AuthProvider) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no AuthProvider provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from auth_provider")
	}
...
func (q authProviderQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no authProviderQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from auth_provider")
	}
...
func (o AuthProviderSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no AuthProvider slice provided for delete all")
	}
...
func (o AuthProviderSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from authProvider slice")
	}
...
func (o *AuthProvider) ReloadG() error {
	if o == nil {
		return errors.New("models: no AuthProvider provided for reload")
	}
...
func (o *AuthProviderSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AuthProviderSlice provided for reload all")
	}
