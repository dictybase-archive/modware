...
func (q analysisfeaturepropQuery) One() (*Analysisfeatureprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for analysisfeatureprop")
	}
...
func (q analysisfeaturepropQuery) All() (AnalysisfeaturepropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Analysisfeatureprop slice")
	}
...
func (q analysisfeaturepropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count analysisfeatureprop rows")
	}
...
func (q analysisfeaturepropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if analysisfeatureprop exists")
	}
...
func FindAnalysisfeatureprop(exec boil.Executor, analysisfeaturepropID int, selectCols ...string) (*Analysisfeatureprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from analysisfeatureprop")
	}
...
func (o *Analysisfeatureprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisfeatureprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into analysisfeatureprop")
	}
...
func (o *Analysisfeatureprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update analysisfeatureprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update analysisfeatureprop row")
	}
...
func (q analysisfeaturepropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for analysisfeatureprop")
	}
...
func (o AnalysisfeaturepropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in analysisfeatureprop slice")
	}
...
func (o *Analysisfeatureprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisfeatureprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert analysisfeatureprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for analysisfeatureprop")
	}
...
func (o *Analysisfeatureprop) DeleteG() error {
	if o == nil {
		return errors.New("models: no Analysisfeatureprop provided for deletion")
	}
...
func (o *Analysisfeatureprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Analysisfeatureprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from analysisfeatureprop")
	}
...
func (q analysisfeaturepropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no analysisfeaturepropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisfeatureprop")
	}
...
func (o AnalysisfeaturepropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Analysisfeatureprop slice provided for delete all")
	}
...
func (o AnalysisfeaturepropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisfeatureprop slice")
	}
...
func (o *Analysisfeatureprop) ReloadG() error {
	if o == nil {
		return errors.New("models: no Analysisfeatureprop provided for reload")
	}
...
func (o *AnalysisfeaturepropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AnalysisfeaturepropSlice provided for reload all")
	}
...
func (o *AnalysisfeaturepropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in AnalysisfeaturepropSlice")
	}
...
func AnalysisfeaturepropExists(exec boil.Executor, analysisfeaturepropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if analysisfeatureprop exists")
	}
