...
func (q cvQuery) One() (*CV, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for cv")
	}
...
func (q cvQuery) All() (CVSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to CV slice")
	}
...
func (q cvQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count cv rows")
	}
...
func (q cvQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if cv exists")
	}
...
func FindCV(exec boil.Executor, cvID int, selectCols ...string) (*CV, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from cv")
	}
...
func (o *CV) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cv provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into cv")
	}
...
func (o *CV) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update cv, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update cv row")
	}
...
func (q cvQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for cv")
	}
...
func (o CVSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in cv slice")
	}
...
func (o *CV) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cv provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert cv, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for cv")
	}
...
func (o *CV) DeleteG() error {
	if o == nil {
		return errors.New("models: no CV provided for deletion")
	}
...
func (o *CV) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no CV provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from cv")
	}
...
func (q cvQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no cvQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cv")
	}
...
func (o CVSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no CV slice provided for delete all")
	}
...
func (o CVSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cv slice")
	}
...
func (o *CV) ReloadG() error {
	if o == nil {
		return errors.New("models: no CV provided for reload")
	}
...
func (o *CVSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CVSlice provided for reload all")
	}
...
func (o *CVSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&cvs)
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CVSlice")
	}
...
func CVExists(exec boil.Executor, cvID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if cv exists")
	}
