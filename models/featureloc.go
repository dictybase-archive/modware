...
func (q featurelocQuery) One() (*Featureloc, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for featureloc")
	}
...
func (q featurelocQuery) All() (FeaturelocSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Featureloc slice")
	}
...
func (q featurelocQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count featureloc rows")
	}
...
func (q featurelocQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if featureloc exists")
	}
...
func FindFeatureloc(exec boil.Executor, featurelocID int, selectCols ...string) (*Featureloc, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from featureloc")
	}
...
func (o *Featureloc) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no featureloc provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into featureloc")
	}
...
func (o *Featureloc) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update featureloc, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update featureloc row")
	}
...
func (q featurelocQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for featureloc")
	}
...
func (o FeaturelocSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureloc slice")
	}
...
func (o *Featureloc) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no featureloc provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert featureloc, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for featureloc")
	}
...
func (o *Featureloc) DeleteG() error {
	if o == nil {
		return errors.New("models: no Featureloc provided for deletion")
	}
...
func (o *Featureloc) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Featureloc provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from featureloc")
	}
...
func (q featurelocQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featurelocQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureloc")
	}
...
func (o FeaturelocSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Featureloc slice provided for delete all")
	}
...
func (o FeaturelocSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureloc slice")
	}
...
func (o *Featureloc) ReloadG() error {
	if o == nil {
		return errors.New("models: no Featureloc provided for reload")
	}
...
func (o *FeaturelocSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeaturelocSlice provided for reload all")
	}
...
func (o *FeaturelocSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeaturelocSlice")
	}
...
func FeaturelocExists(exec boil.Executor, featurelocID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if featureloc exists")
	}
