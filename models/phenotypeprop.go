...
func (q phenotypepropQuery) One() (*Phenotypeprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for phenotypeprop")
	}
...
func (q phenotypepropQuery) All() (PhenotypepropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Phenotypeprop slice")
	}
...
func (q phenotypepropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count phenotypeprop rows")
	}
...
func (q phenotypepropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if phenotypeprop exists")
	}
...
func FindPhenotypeprop(exec boil.Executor, phenotypepropID int, selectCols ...string) (*Phenotypeprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from phenotypeprop")
	}
...
func (o *Phenotypeprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotypeprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into phenotypeprop")
	}
...
func (o *Phenotypeprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update phenotypeprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update phenotypeprop row")
	}
...
func (q phenotypepropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for phenotypeprop")
	}
...
func (o PhenotypepropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in phenotypeprop slice")
	}
...
func (o *Phenotypeprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotypeprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert phenotypeprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for phenotypeprop")
	}
...
func (o *Phenotypeprop) DeleteG() error {
	if o == nil {
		return errors.New("models: no Phenotypeprop provided for deletion")
	}
...
func (o *Phenotypeprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Phenotypeprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from phenotypeprop")
	}
...
func (q phenotypepropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no phenotypepropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotypeprop")
	}
...
func (o PhenotypepropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Phenotypeprop slice provided for delete all")
	}
...
func (o PhenotypepropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotypeprop slice")
	}
...
func (o *Phenotypeprop) ReloadG() error {
	if o == nil {
		return errors.New("models: no Phenotypeprop provided for reload")
	}
...
func (o *PhenotypepropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PhenotypepropSlice provided for reload all")
	}
...
func (o *PhenotypepropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PhenotypepropSlice")
	}
...
func PhenotypepropExists(exec boil.Executor, phenotypepropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if phenotypeprop exists")
	}
