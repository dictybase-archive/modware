...
func (q cvtermsynonymQuery) One() (*Cvtermsynonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for cvtermsynonym")
	}
...
func (q cvtermsynonymQuery) All() (CvtermsynonymSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Cvtermsynonym slice")
	}
...
func (q cvtermsynonymQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count cvtermsynonym rows")
	}
...
func (q cvtermsynonymQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if cvtermsynonym exists")
	}
...
func FindCvtermsynonym(exec boil.Executor, cvtermsynonymID int, selectCols ...string) (*Cvtermsynonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from cvtermsynonym")
	}
...
func (o *Cvtermsynonym) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermsynonym provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into cvtermsynonym")
	}
...
func (o *Cvtermsynonym) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update cvtermsynonym, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update cvtermsynonym row")
	}
...
func (q cvtermsynonymQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for cvtermsynonym")
	}
...
func (o CvtermsynonymSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in cvtermsynonym slice")
	}
...
func (o *Cvtermsynonym) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermsynonym provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert cvtermsynonym, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for cvtermsynonym")
	}
...
func (o *Cvtermsynonym) DeleteG() error {
	if o == nil {
		return errors.New("models: no Cvtermsynonym provided for deletion")
	}
...
func (o *Cvtermsynonym) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Cvtermsynonym provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from cvtermsynonym")
	}
...
func (q cvtermsynonymQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no cvtermsynonymQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermsynonym")
	}
...
func (o CvtermsynonymSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Cvtermsynonym slice provided for delete all")
	}
...
func (o CvtermsynonymSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermsynonym slice")
	}
...
func (o *Cvtermsynonym) ReloadG() error {
	if o == nil {
		return errors.New("models: no Cvtermsynonym provided for reload")
	}
...
func (o *CvtermsynonymSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CvtermsynonymSlice provided for reload all")
	}
...
func (o *CvtermsynonymSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CvtermsynonymSlice")
	}
...
func CvtermsynonymExists(exec boil.Executor, cvtermsynonymID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if cvtermsynonym exists")
	}
