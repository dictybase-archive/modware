...
func (q stockGenotypeQuery) One() (*StockGenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for stock_genotype")
	}
...
func (q stockGenotypeQuery) All() (StockGenotypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to StockGenotype slice")
	}
...
func (q stockGenotypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count stock_genotype rows")
	}
...
func (q stockGenotypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if stock_genotype exists")
	}
...
func FindStockGenotype(exec boil.Executor, stockGenotypeID int, selectCols ...string) (*StockGenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from stock_genotype")
	}
...
func (o *StockGenotype) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_genotype provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into stock_genotype")
	}
...
func (o *StockGenotype) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update stock_genotype, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update stock_genotype row")
	}
...
func (q stockGenotypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for stock_genotype")
	}
...
func (o StockGenotypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in stockGenotype slice")
	}
...
func (o *StockGenotype) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_genotype provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert stock_genotype, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for stock_genotype")
	}
...
func (o *StockGenotype) DeleteG() error {
	if o == nil {
		return errors.New("models: no StockGenotype provided for deletion")
	}
...
func (o *StockGenotype) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no StockGenotype provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from stock_genotype")
	}
...
func (q stockGenotypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no stockGenotypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stock_genotype")
	}
...
func (o StockGenotypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no StockGenotype slice provided for delete all")
	}
...
func (o StockGenotypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stockGenotype slice")
	}
...
func (o *StockGenotype) ReloadG() error {
	if o == nil {
		return errors.New("models: no StockGenotype provided for reload")
	}
...
func (o *StockGenotypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StockGenotypeSlice provided for reload all")
	}
...
func (o *StockGenotypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in StockGenotypeSlice")
	}
...
func StockGenotypeExists(exec boil.Executor, stockGenotypeID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if stock_genotype exists")
	}
