...
func (q phenotypeQuery) One() (*Phenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for phenotype")
	}
...
func (q phenotypeQuery) All() (PhenotypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Phenotype slice")
	}
...
func (q phenotypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count phenotype rows")
	}
...
func (q phenotypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if phenotype exists")
	}
...
func FindPhenotype(exec boil.Executor, phenotypeID int, selectCols ...string) (*Phenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from phenotype")
	}
...
func (o *Phenotype) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotype provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into phenotype")
	}
...
func (o *Phenotype) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update phenotype, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update phenotype row")
	}
...
func (q phenotypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for phenotype")
	}
...
func (o PhenotypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in phenotype slice")
	}
...
func (o *Phenotype) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotype provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert phenotype, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for phenotype")
	}
...
func (o *Phenotype) DeleteG() error {
	if o == nil {
		return errors.New("models: no Phenotype provided for deletion")
	}
...
func (o *Phenotype) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Phenotype provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from phenotype")
	}
...
func (q phenotypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no phenotypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotype")
	}
...
func (o PhenotypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Phenotype slice provided for delete all")
	}
...
func (o PhenotypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotype slice")
	}
...
func (o *Phenotype) ReloadG() error {
	if o == nil {
		return errors.New("models: no Phenotype provided for reload")
	}
...
func (o *PhenotypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PhenotypeSlice provided for reload all")
	}
...
func (o *PhenotypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PhenotypeSlice")
	}
...
func PhenotypeExists(exec boil.Executor, phenotypeID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if phenotype exists")
	}
