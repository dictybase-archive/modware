...
func (q dbxrefQuery) One() (*Dbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for dbxref")
	}
...
func (q dbxrefQuery) All() (DbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Dbxref slice")
	}
...
func (q dbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count dbxref rows")
	}
...
func (q dbxrefQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if dbxref exists")
	}
...
func FindDbxref(exec boil.Executor, dbxrefID int, selectCols ...string) (*Dbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from dbxref")
	}
...
func (o *Dbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into dbxref")
	}
...
func (o *Dbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update dbxref row")
	}
...
func (q dbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for dbxref")
	}
...
func (o DbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in dbxref slice")
	}
...
func (o *Dbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for dbxref")
	}
...
func (o *Dbxref) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Dbxref provided for deletion")
	}
...
func (o *Dbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Dbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from dbxref")
	}
...
func (q dbxrefQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no dbxrefQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from dbxref")
	}
...
func (o DbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Dbxref slice provided for delete all")
	}
...
func (o DbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from dbxref slice")
	}
...
func (o *Dbxref) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Dbxref provided for reload")
	}
...
func (o *DbxrefSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty DbxrefSlice provided for reload all")
	}
...
func (o *DbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&dbxrefs)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in DbxrefSlice")
	}
...
func DbxrefExists(exec boil.Executor, dbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if dbxref exists")
	}
