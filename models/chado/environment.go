...
func (q environmentQuery) One() (*Environment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for environment")
	}
...
func (q environmentQuery) All() (EnvironmentSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Environment slice")
	}
...
func (q environmentQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count environment rows")
	}
...
func (q environmentQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if environment exists")
	}
...
func FindEnvironment(exec boil.Executor, environmentID int, selectCols ...string) (*Environment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from environment")
	}
...
func (o *Environment) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no environment provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into environment")
	}
...
func (o *Environment) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update environment, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update environment row")
	}
...
func (q environmentQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for environment")
	}
...
func (o EnvironmentSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in environment slice")
	}
...
func (o *Environment) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no environment provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert environment, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for environment")
	}
...
func (o *Environment) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Environment provided for deletion")
	}
...
func (o *Environment) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Environment provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from environment")
	}
...
func (q environmentQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no environmentQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from environment")
	}
...
func (o EnvironmentSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Environment slice provided for delete all")
	}
...
func (o EnvironmentSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from environment slice")
	}
...
func (o *Environment) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Environment provided for reload")
	}
...
func (o *EnvironmentSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty EnvironmentSlice provided for reload all")
	}
...
func (o *EnvironmentSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in EnvironmentSlice")
	}
...
func EnvironmentExists(exec boil.Executor, environmentID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if environment exists")
	}
