...
func (q authRolePermissionQuery) One() (*AuthRolePermission, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for auth_role_permission")
	}
...
func (q authRolePermissionQuery) All() (AuthRolePermissionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to AuthRolePermission slice")
	}
...
func (q authRolePermissionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count auth_role_permission rows")
	}
...
func (q authRolePermissionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if auth_role_permission exists")
	}
...
func FindAuthRolePermission(exec boil.Executor, authRolePermissionID int, selectCols ...string) (*AuthRolePermission, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from auth_role_permission")
	}
...
func (o AuthRolePermissionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in authRolePermission slice")
	}
...
func (q authRolePermissionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no authRolePermissionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from auth_role_permission")
	}
...
func (o AuthRolePermissionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no AuthRolePermission slice provided for delete all")
	}
...
func (o AuthRolePermissionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from authRolePermission slice")
	}
...
func (o *AuthRolePermissionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty AuthRolePermissionSlice provided for reload all")
	}
...
func (o *AuthRolePermissionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in AuthRolePermissionSlice")
	}
...
func AuthRolePermissionExists(exec boil.Executor, authRolePermissionID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if auth_role_permission exists")
	}
