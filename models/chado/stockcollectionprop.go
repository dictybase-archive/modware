...
func (q stockcollectionpropQuery) One() (*Stockcollectionprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stockcollectionprop")
	}
...
func (q stockcollectionpropQuery) All() (StockcollectionpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Stockcollectionprop slice")
	}
...
func (q stockcollectionpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stockcollectionprop exists")
	}
...
func FindStockcollectionprop(exec boil.Executor, stockcollectionpropID int, selectCols ...string) (*Stockcollectionprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stockcollectionprop")
	}
...
func (o *Stockcollectionprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockcollectionprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stockcollectionprop")
	}
...
func (o *Stockcollectionprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stockcollectionprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stockcollectionprop row")
	}
...
func (q stockcollectionpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stockcollectionprop")
	}
...
func (o StockcollectionpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockcollectionprop slice")
	}
...
func (o *Stockcollectionprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockcollectionprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stockcollectionprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stockcollectionprop")
	}
...
func (o *Stockcollectionprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Stockcollectionprop provided for deletion")
	}
...
func (o *Stockcollectionprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Stockcollectionprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stockcollectionprop")
	}
...
func (q stockcollectionpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockcollectionpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockcollectionprop")
	}
...
func (o StockcollectionpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Stockcollectionprop slice provided for delete all")
	}
...
func (o StockcollectionpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockcollectionprop slice")
	}
...
func (o *Stockcollectionprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Stockcollectionprop provided for reload")
	}
...
func (o *StockcollectionpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockcollectionpropSlice provided for reload all")
	}
...
func (o *StockcollectionpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockcollectionpropSlice")
	}
...
func StockcollectionpropExists(exec boil.Executor, stockcollectionpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stockcollectionprop exists")
	}
