...
func (q chadopropQuery) One() (*Chadoprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for chadoprop")
	}
...
func (q chadopropQuery) All() (ChadopropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Chadoprop slice")
	}
...
func (q chadopropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count chadoprop rows")
	}
...
func (q chadopropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if chadoprop exists")
	}
...
func FindChadoprop(exec boil.Executor, chadopropID int, selectCols ...string) (*Chadoprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from chadoprop")
	}
...
func (o *Chadoprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no chadoprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into chadoprop")
	}
...
func (o *Chadoprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update chadoprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update chadoprop row")
	}
...
func (q chadopropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for chadoprop")
	}
...
func (o ChadopropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in chadoprop slice")
	}
...
func (o *Chadoprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no chadoprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert chadoprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for chadoprop")
	}
...
func (o *Chadoprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Chadoprop provided for deletion")
	}
...
func (q chadopropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no chadopropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from chadoprop")
	}
...
func (o ChadopropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Chadoprop slice provided for delete all")
	}
...
func (o ChadopropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from chadoprop slice")
	}
...
func (o *Chadoprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Chadoprop provided for reload")
	}
...
func (o *ChadopropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty ChadopropSlice provided for reload all")
	}
...
func (o *ChadopropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in ChadopropSlice")
	}
...
func ChadopropExists(exec boil.Executor, chadopropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if chadoprop exists")
	}
