...
func (q stockDbxrefQuery) One() (*StockDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_dbxref")
	}
...
func (q stockDbxrefQuery) All() (StockDbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockDbxref slice")
	}
...
func (q stockDbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_dbxref rows")
	}
...
func (q stockDbxrefQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stock_dbxref exists")
	}
...
func FindStockDbxref(exec boil.Executor, stockDbxrefID int, selectCols ...string) (*StockDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_dbxref")
	}
...
func (o *StockDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_dbxref")
	}
...
func (o *StockDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_dbxref row")
	}
...
func (q stockDbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_dbxref")
	}
...
func (o StockDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockDbxref slice")
	}
...
func (o *StockDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_dbxref")
	}
...
func (o *StockDbxref) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockDbxref provided for deletion")
	}
...
func (o *StockDbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockDbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_dbxref")
	}
...
func (q stockDbxrefQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockDbxrefQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_dbxref")
	}
...
func (o StockDbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockDbxref slice provided for delete all")
	}
...
func (o StockDbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockDbxref slice")
	}
...
func (o *StockDbxref) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockDbxref provided for reload")
	}
...
func (o *StockDbxrefSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockDbxrefSlice provided for reload all")
	}
...
func (o *StockDbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockDbxrefSlice")
	}
...
func StockDbxrefExists(exec boil.Executor, stockDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stock_dbxref exists")
	}
