...
func (q stockpropPubQuery) One() (*StockpropPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stockprop_pub")
	}
...
func (q stockpropPubQuery) All() (StockpropPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockpropPub slice")
	}
...
func (q stockpropPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stockprop_pub rows")
	}
...
func (q stockpropPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stockprop_pub exists")
	}
...
func FindStockpropPub(exec boil.Executor, stockpropPubID int, selectCols ...string) (*StockpropPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stockprop_pub")
	}
...
func (o *StockpropPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockprop_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stockprop_pub")
	}
...
func (o *StockpropPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stockprop_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stockprop_pub row")
	}
...
func (q stockpropPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stockprop_pub")
	}
...
func (o StockpropPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockpropPub slice")
	}
...
func (o *StockpropPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockprop_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stockprop_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stockprop_pub")
	}
...
func (o *StockpropPub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockpropPub provided for deletion")
	}
...
func (o *StockpropPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockpropPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stockprop_pub")
	}
...
func (q stockpropPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockpropPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockprop_pub")
	}
...
func (o StockpropPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockpropPub slice provided for delete all")
	}
...
func (o StockpropPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockpropPub slice")
	}
...
func (o *StockpropPub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockpropPub provided for reload")
	}
...
func (o *StockpropPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockpropPubSlice provided for reload all")
	}
...
func (o *StockpropPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockpropPubSlice")
	}
...
func StockpropPubExists(exec boil.Executor, stockpropPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stockprop_pub exists")
	}
