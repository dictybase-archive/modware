...
func (q cvtermQuery) One() (*Cvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for cvterm")
	}
...
func (q cvtermQuery) All() (CvtermSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Cvterm slice")
	}
...
func (q cvtermQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count cvterm rows")
	}
...
func (q cvtermQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if cvterm exists")
	}
...
func FindCvterm(exec boil.Executor, cvtermID int, selectCols ...string) (*Cvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from cvterm")
	}
...
func (o *Cvterm) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no cvterm provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into cvterm")
	}
...
func (o *Cvterm) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update cvterm, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update cvterm row")
	}
...
func (q cvtermQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for cvterm")
	}
...
func (o CvtermSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in cvterm slice")
	}
...
func (o *Cvterm) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Cvterm provided for deletion")
	}
...
func (o *Cvterm) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Cvterm provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from cvterm")
	}
...
func (q cvtermQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no cvtermQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from cvterm")
	}
...
func (o CvtermSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Cvterm slice provided for delete all")
	}
...
func (o CvtermSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from cvterm slice")
	}
...
func (o *Cvterm) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Cvterm provided for reload")
	}
...
func (o *CvtermSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty CvtermSlice provided for reload all")
	}
...
func (o *CvtermSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&cvterms)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in CvtermSlice")
	}
...
func CvtermExists(exec boil.Executor, cvtermID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if cvterm exists")
	}
