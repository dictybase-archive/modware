...
func (q stockpropQuery) One() (*Stockprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stockprop")
	}
...
func (q stockpropQuery) All() (StockpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Stockprop slice")
	}
...
func (q stockpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stockprop rows")
	}
...
func (q stockpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stockprop exists")
	}
...
func FindStockprop(exec boil.Executor, stockpropID int, selectCols ...string) (*Stockprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stockprop")
	}
...
func (o *Stockprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stockprop")
	}
...
func (o *Stockprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stockprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stockprop row")
	}
...
func (q stockpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stockprop")
	}
...
func (o StockpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockprop slice")
	}
...
func (o *Stockprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stockprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stockprop")
	}
...
func (o *Stockprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Stockprop provided for deletion")
	}
...
func (o *Stockprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Stockprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stockprop")
	}
...
func (q stockpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockprop")
	}
...
func (o StockpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Stockprop slice provided for delete all")
	}
...
func (o StockpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockprop slice")
	}
...
func (o *Stockprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Stockprop provided for reload")
	}
...
func (o *StockpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockpropSlice provided for reload all")
	}
...
func (o *StockpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockpropSlice")
	}
...
func StockpropExists(exec boil.Executor, stockpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stockprop exists")
	}
