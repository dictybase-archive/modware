...
func (q cvpropQuery) One() (*Cvprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for cvprop")
	}
...
func (q cvpropQuery) All() (CvpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Cvprop slice")
	}
...
func (q cvpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count cvprop rows")
	}
...
func (q cvpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if cvprop exists")
	}
...
func FindCvprop(exec boil.Executor, cvpropID int, selectCols ...string) (*Cvprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from cvprop")
	}
...
func (o *Cvprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no cvprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into cvprop")
	}
...
func (o *Cvprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update cvprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update cvprop row")
	}
...
func (q cvpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for cvprop")
	}
...
func (o CvpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in cvprop slice")
	}
...
func (o *Cvprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no cvprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert cvprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for cvprop")
	}
...
func (o *Cvprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Cvprop provided for deletion")
	}
...
func (o *Cvprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Cvprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from cvprop")
	}
...
func (q cvpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no cvpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from cvprop")
	}
...
func (o CvpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Cvprop slice provided for delete all")
	}
...
func (o CvpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from cvprop slice")
	}
...
func (o *Cvprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Cvprop provided for reload")
	}
...
func (o *CvpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty CvpropSlice provided for reload all")
	}
...
func (o *CvpropSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&cvprops)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in CvpropSlice")
	}
...
func CvpropExists(exec boil.Executor, cvpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if cvprop exists")
	}
