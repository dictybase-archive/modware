...
func (q analysiQuery) One() (*Analysi, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for analysis")
	}
...
func (q analysiQuery) All() (AnalysiSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Analysi slice")
	}
...
func (q analysiQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count analysis rows")
	}
...
func (q analysiQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if analysis exists")
	}
...
func FindAnalysi(exec boil.Executor, analysisID int, selectCols ...string) (*Analysi, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from analysis")
	}
...
func (o *Analysi) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no analysis provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into analysis")
	}
...
func (o *Analysi) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update analysis, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update analysis row")
	}
...
func (q analysiQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for analysis")
	}
...
func (o AnalysiSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in analysi slice")
	}
...
func (o *Analysi) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no analysis provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert analysis, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for analysis")
	}
...
func (o *Analysi) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Analysi provided for deletion")
	}
...
func (o *Analysi) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Analysi provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from analysis")
	}
...
func (q analysiQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no analysiQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from analysis")
	}
...
func (o AnalysiSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Analysi slice provided for delete all")
	}
...
func (o AnalysiSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from analysi slice")
	}
...
func (o *Analysi) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Analysi provided for reload")
	}
...
func (o *AnalysiSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty AnalysiSlice provided for reload all")
	}
...
func (o *AnalysiSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&analyses)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in AnalysiSlice")
	}
...
func AnalysiExists(exec boil.Executor, analysisID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if analysis exists")
	}
