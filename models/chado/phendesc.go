...
func (q phendescQuery) One() (*Phendesc, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for phendesc")
	}
...
func (q phendescQuery) All() (PhendescSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Phendesc slice")
	}
...
func (q phendescQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count phendesc rows")
	}
...
func (q phendescQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if phendesc exists")
	}
...
func FindPhendesc(exec boil.Executor, phendescID int, selectCols ...string) (*Phendesc, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from phendesc")
	}
...
func (o *Phendesc) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no phendesc provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into phendesc")
	}
...
func (o *Phendesc) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update phendesc, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update phendesc row")
	}
...
func (q phendescQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for phendesc")
	}
...
func (o PhendescSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in phendesc slice")
	}
...
func (o *Phendesc) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no phendesc provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert phendesc, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for phendesc")
	}
...
func (o *Phendesc) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Phendesc provided for deletion")
	}
...
func (o *Phendesc) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Phendesc provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from phendesc")
	}
...
func (q phendescQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no phendescQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from phendesc")
	}
...
func (o PhendescSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Phendesc slice provided for delete all")
	}
...
func (o PhendescSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from phendesc slice")
	}
...
func (o *Phendesc) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Phendesc provided for reload")
	}
...
func (o *PhendescSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty PhendescSlice provided for reload all")
	}
...
func (o *PhendescSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in PhendescSlice")
	}
...
func PhendescExists(exec boil.Executor, phendescID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if phendesc exists")
	}
