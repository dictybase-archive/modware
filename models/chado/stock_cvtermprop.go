...
func (q stockCvtermpropQuery) One() (*StockCvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_cvtermprop")
	}
...
func (q stockCvtermpropQuery) All() (StockCvtermpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockCvtermprop slice")
	}
...
func (q stockCvtermpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_cvtermprop rows")
	}
...
func (q stockCvtermpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stock_cvtermprop exists")
	}
...
func FindStockCvtermprop(exec boil.Executor, stockCvtermpropID int, selectCols ...string) (*StockCvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_cvtermprop")
	}
...
func (o *StockCvtermprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_cvtermprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_cvtermprop")
	}
...
func (o *StockCvtermprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_cvtermprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_cvtermprop row")
	}
...
func (q stockCvtermpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_cvtermprop")
	}
...
func (o StockCvtermpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockCvtermprop slice")
	}
...
func (o *StockCvtermprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_cvtermprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_cvtermprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_cvtermprop")
	}
...
func (o *StockCvtermprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockCvtermprop provided for deletion")
	}
...
func (o *StockCvtermprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockCvtermprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_cvtermprop")
	}
...
func (q stockCvtermpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockCvtermpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_cvtermprop")
	}
...
func (o StockCvtermpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockCvtermprop slice provided for delete all")
	}
...
func (o StockCvtermpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockCvtermprop slice")
	}
...
func (o *StockCvtermprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockCvtermprop provided for reload")
	}
...
func (o *StockCvtermpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockCvtermpropSlice provided for reload all")
	}
...
func (o *StockCvtermpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockCvtermpropSlice")
	}
...
func StockCvtermpropExists(exec boil.Executor, stockCvtermpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stock_cvtermprop exists")
	}
