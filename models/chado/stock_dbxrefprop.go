...
func (q stockDbxrefpropQuery) One() (*StockDbxrefprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_dbxrefprop")
	}
...
func (q stockDbxrefpropQuery) All() (StockDbxrefpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockDbxrefprop slice")
	}
...
func (q stockDbxrefpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_dbxrefprop rows")
	}
...
func (q stockDbxrefpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stock_dbxrefprop exists")
	}
...
func FindStockDbxrefprop(exec boil.Executor, stockDbxrefpropID int, selectCols ...string) (*StockDbxrefprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_dbxrefprop")
	}
...
func (o *StockDbxrefprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_dbxrefprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_dbxrefprop")
	}
...
func (o *StockDbxrefprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_dbxrefprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_dbxrefprop row")
	}
...
func (q stockDbxrefpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_dbxrefprop")
	}
...
func (o StockDbxrefpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockDbxrefprop slice")
	}
...
func (o *StockDbxrefprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_dbxrefprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_dbxrefprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_dbxrefprop")
	}
...
func (o *StockDbxrefprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockDbxrefprop provided for deletion")
	}
...
func (o *StockDbxrefprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockDbxrefprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_dbxrefprop")
	}
...
func (q stockDbxrefpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockDbxrefpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_dbxrefprop")
	}
...
func (o StockDbxrefpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockDbxrefprop slice provided for delete all")
	}
...
func (o StockDbxrefpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockDbxrefprop slice")
	}
...
func (o *StockDbxrefprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockDbxrefprop provided for reload")
	}
...
func (o *StockDbxrefpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockDbxrefpropSlice provided for reload all")
	}
...
func (o *StockDbxrefpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockDbxrefpropSlice")
	}
...
func StockDbxrefpropExists(exec boil.Executor, stockDbxrefpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stock_dbxrefprop exists")
	}
