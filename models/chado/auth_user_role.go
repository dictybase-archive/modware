...
func (o *AuthUserRole) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update auth_user_role, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update auth_user_role row")
	}
...
func (o AuthUserRoleSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in authUserRole slice")
	}
...
func (o *AuthUserRole) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no auth_user_role provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert auth_user_role, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for auth_user_role")
	}
...
func (o *AuthUserRole) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no AuthUserRole provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from auth_user_role")
	}
...
func (o AuthUserRoleSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no AuthUserRole slice provided for delete all")
	}
...
func (o AuthUserRoleSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from authUserRole slice")
	}
...
func (o *AuthUserRoleSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in AuthUserRoleSlice")
	}
