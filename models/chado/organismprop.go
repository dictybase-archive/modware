...
func (q organismpropQuery) One() (*Organismprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for organismprop")
	}
...
func (q organismpropQuery) All() (OrganismpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Organismprop slice")
	}
...
func (q organismpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count organismprop rows")
	}
...
func (q organismpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if organismprop exists")
	}
...
func FindOrganismprop(exec boil.Executor, organismpropID int, selectCols ...string) (*Organismprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from organismprop")
	}
...
func (o *Organismprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no organismprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into organismprop")
	}
...
func (o *Organismprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update organismprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update organismprop row")
	}
...
func (q organismpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for organismprop")
	}
...
func (o OrganismpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in organismprop slice")
	}
...
func (o *Organismprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no organismprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert organismprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for organismprop")
	}
...
func (o *Organismprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Organismprop provided for deletion")
	}
...
func (o *Organismprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Organismprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from organismprop")
	}
...
func (q organismpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no organismpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from organismprop")
	}
...
func (o OrganismpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Organismprop slice provided for delete all")
	}
...
func (o OrganismpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from organismprop slice")
	}
...
func (o *Organismprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Organismprop provided for reload")
	}
...
func (o *OrganismpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty OrganismpropSlice provided for reload all")
	}
...
func (o *OrganismpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in OrganismpropSlice")
	}
...
func OrganismpropExists(exec boil.Executor, organismpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if organismprop exists")
	}
