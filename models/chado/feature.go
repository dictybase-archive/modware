...
func (q featureQuery) One() (*Feature, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature")
	}
...
func (q featureQuery) All() (FeatureSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Feature slice")
	}
...
func (q featureQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature exists")
	}
...
func FindFeature(exec boil.Executor, featureID int, selectCols ...string) (*Feature, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature")
	}
...
func (o *Feature) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature")
	}
...
func (o *Feature) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature row")
	}
...
func (q featureQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature")
	}
...
func (o FeatureSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in feature slice")
	}
...
func (o *Feature) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature")
	}
...
func (o *Feature) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Feature provided for deletion")
	}
...
func (o *Feature) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Feature provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature")
	}
...
func (q featureQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featureQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature")
	}
...
func (o FeatureSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Feature slice provided for delete all")
	}
...
func (o FeatureSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature slice")
	}
...
func (o *Feature) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Feature provided for reload")
	}
...
func (o *FeatureSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeatureSlice provided for reload all")
	}
...
func (o *FeatureSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&features)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeatureSlice")
	}
...
func FeatureExists(exec boil.Executor, featureID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature exists")
	}
