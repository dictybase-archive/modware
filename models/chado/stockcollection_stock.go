...
func (q stockcollectionStockQuery) One() (*StockcollectionStock, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stockcollection_stock")
	}
...
func (q stockcollectionStockQuery) All() (StockcollectionStockSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockcollectionStock slice")
	}
...
func (q stockcollectionStockQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stockcollection_stock rows")
	}
...
func (q stockcollectionStockQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stockcollection_stock exists")
	}
...
func FindStockcollectionStock(exec boil.Executor, stockcollectionStockID int, selectCols ...string) (*StockcollectionStock, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stockcollection_stock")
	}
...
func (o *StockcollectionStock) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockcollection_stock provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stockcollection_stock")
	}
...
func (o *StockcollectionStock) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stockcollection_stock, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stockcollection_stock row")
	}
...
func (q stockcollectionStockQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stockcollection_stock")
	}
...
func (o StockcollectionStockSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockcollectionStock slice")
	}
...
func (o *StockcollectionStock) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stockcollection_stock provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stockcollection_stock, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stockcollection_stock")
	}
...
func (o *StockcollectionStock) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockcollectionStock provided for deletion")
	}
...
func (o *StockcollectionStock) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockcollectionStock provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stockcollection_stock")
	}
...
func (q stockcollectionStockQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockcollectionStockQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockcollection_stock")
	}
...
func (o StockcollectionStockSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockcollectionStock slice provided for delete all")
	}
...
func (o StockcollectionStockSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockcollectionStock slice")
	}
...
func (o *StockcollectionStock) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockcollectionStock provided for reload")
	}
...
func (o *StockcollectionStockSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockcollectionStockSlice provided for reload all")
	}
...
func (o *StockcollectionStockSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockcollectionStockSlice")
	}
...
func StockcollectionStockExists(exec boil.Executor, stockcollectionStockID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stockcollection_stock exists")
	}
