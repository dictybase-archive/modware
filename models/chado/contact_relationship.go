...
func (q contactRelationshipQuery) One() (*ContactRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for contact_relationship")
	}
...
func (q contactRelationshipQuery) All() (ContactRelationshipSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to ContactRelationship slice")
	}
...
func FindContactRelationship(exec boil.Executor, contactRelationshipID int, selectCols ...string) (*ContactRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from contact_relationship")
	}
...
func (o *ContactRelationship) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no contact_relationship provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into contact_relationship")
	}
...
func (o *ContactRelationship) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update contact_relationship, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update contact_relationship row")
	}
...
func (q contactRelationshipQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for contact_relationship")
	}
...
func (o ContactRelationshipSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in contactRelationship slice")
	}
...
func (o *ContactRelationship) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no contact_relationship provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert contact_relationship, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for contact_relationship")
	}
...
func (o *ContactRelationship) DeleteG() error {
	if o == nil {
		return errors.New("chado: no ContactRelationship provided for deletion")
	}
...
func (o *ContactRelationship) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no ContactRelationship provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from contact_relationship")
	}
...
func (q contactRelationshipQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no contactRelationshipQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from contact_relationship")
	}
...
func (o ContactRelationshipSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no ContactRelationship slice provided for delete all")
	}
...
func (o ContactRelationshipSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from contactRelationship slice")
	}
...
func (o *ContactRelationship) ReloadG() error {
	if o == nil {
		return errors.New("chado: no ContactRelationship provided for reload")
	}
...
func (o *ContactRelationshipSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty ContactRelationshipSlice provided for reload all")
	}
...
func (o *ContactRelationshipSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in ContactRelationshipSlice")
	}
...
func ContactRelationshipExists(exec boil.Executor, contactRelationshipID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if contact_relationship exists")
	}
