...
func (q featureCvtermDbxrefQuery) All() (FeatureCvtermDbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeatureCvtermDbxref slice")
	}
...
func (q featureCvtermDbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_cvterm_dbxref rows")
	}
...
func FindFeatureCvtermDbxref(exec boil.Executor, featureCvtermDbxrefID int, selectCols ...string) (*FeatureCvtermDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_cvterm_dbxref")
	}
...
func (o *FeatureCvtermDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_cvterm_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_cvterm_dbxref")
	}
...
func (o *FeatureCvtermDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature_cvterm_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature_cvterm_dbxref row")
	}
...
func (q featureCvtermDbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_cvterm_dbxref")
	}
...
func (o FeatureCvtermDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureCvtermDbxref slice")
	}
...
func (o *FeatureCvtermDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_cvterm_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature_cvterm_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature_cvterm_dbxref")
	}
...
func FeatureCvtermDbxrefExists(exec boil.Executor, featureCvtermDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_cvterm_dbxref exists")
	}
