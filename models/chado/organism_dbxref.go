...
func (q organismDbxrefQuery) One() (*OrganismDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for organism_dbxref")
	}
...
func (q organismDbxrefQuery) All() (OrganismDbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to OrganismDbxref slice")
	}
...
func (q organismDbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count organism_dbxref rows")
	}
...
func (q organismDbxrefQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if organism_dbxref exists")
	}
...
func FindOrganismDbxref(exec boil.Executor, organismDbxrefID int, selectCols ...string) (*OrganismDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from organism_dbxref")
	}
...
func (o *OrganismDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no organism_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into organism_dbxref")
	}
...
func (o *OrganismDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update organism_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update organism_dbxref row")
	}
...
func (q organismDbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for organism_dbxref")
	}
...
func (o OrganismDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in organismDbxref slice")
	}
...
func (o *OrganismDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no organism_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert organism_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for organism_dbxref")
	}
...
func (o *OrganismDbxref) DeleteG() error {
	if o == nil {
		return errors.New("chado: no OrganismDbxref provided for deletion")
	}
...
func (o *OrganismDbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no OrganismDbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from organism_dbxref")
	}
...
func (q organismDbxrefQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no organismDbxrefQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from organism_dbxref")
	}
...
func (o OrganismDbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no OrganismDbxref slice provided for delete all")
	}
...
func (o OrganismDbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from organismDbxref slice")
	}
...
func (o *OrganismDbxref) ReloadG() error {
	if o == nil {
		return errors.New("chado: no OrganismDbxref provided for reload")
	}
...
func (o *OrganismDbxrefSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty OrganismDbxrefSlice provided for reload all")
	}
...
func (o *OrganismDbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in OrganismDbxrefSlice")
	}
...
func OrganismDbxrefExists(exec boil.Executor, organismDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if organism_dbxref exists")
	}
