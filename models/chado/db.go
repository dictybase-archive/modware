...
func (q dbQuery) One() (*DB, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for db")
	}
...
func (q dbQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count db rows")
	}
...
func (q dbQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if db exists")
	}
...
func FindDB(exec boil.Executor, dbID int, selectCols ...string) (*DB, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from db")
	}
...
func (o *DB) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no db provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into db")
	}
...
func (o *DB) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update db, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update db row")
	}
...
func (q dbQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for db")
	}
...
func (o DBSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in db slice")
	}
...
func (o *DB) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no db provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert db, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for db")
	}
...
func (o *DB) DeleteG() error {
	if o == nil {
		return errors.New("chado: no DB provided for deletion")
	}
...
func (o *DB) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no DB provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from db")
	}
...
func (q dbQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no dbQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from db")
	}
...
func (o DBSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no DB slice provided for delete all")
	}
...
func (o DBSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from db slice")
	}
...
func (o *DB) ReloadG() error {
	if o == nil {
		return errors.New("chado: no DB provided for reload")
	}
...
func (o *DBSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty DBSlice provided for reload all")
	}
...
func (o *DBSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&dbs)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in DBSlice")
	}
...
func DBExists(exec boil.Executor, dbID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if db exists")
	}
