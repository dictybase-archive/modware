...
func (o *JbrowseOrganism) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no jbrowse_organism provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into jbrowse_organism")
	}
...
func (o *JbrowseOrganism) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update jbrowse_organism, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update jbrowse_organism row")
	}
...
func (o JbrowseOrganismSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in jbrowseOrganism slice")
	}
...
func (o *JbrowseOrganism) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no jbrowse_organism provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert jbrowse_organism, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for jbrowse_organism")
	}
...
func (o *JbrowseOrganism) DeleteG() error {
	if o == nil {
		return errors.New("chado: no JbrowseOrganism provided for deletion")
	}
...
func (o *JbrowseOrganism) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no JbrowseOrganism provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from jbrowse_organism")
	}
...
func (o JbrowseOrganismSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no JbrowseOrganism slice provided for delete all")
	}
...
func (o JbrowseOrganismSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from jbrowseOrganism slice")
	}
...
func (o *JbrowseOrganism) ReloadG() error {
	if o == nil {
		return errors.New("chado: no JbrowseOrganism provided for reload")
	}
...
func (o *JbrowseOrganismSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty JbrowseOrganismSlice provided for reload all")
	}
...
func (o *JbrowseOrganismSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in JbrowseOrganismSlice")
	}
