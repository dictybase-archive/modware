...
func (q featurelocPubQuery) One() (*FeaturelocPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for featureloc_pub")
	}
...
func (q featurelocPubQuery) All() (FeaturelocPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeaturelocPub slice")
	}
...
func (q featurelocPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count featureloc_pub rows")
	}
...
func (q featurelocPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if featureloc_pub exists")
	}
...
func FindFeaturelocPub(exec boil.Executor, featurelocPubID int, selectCols ...string) (*FeaturelocPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from featureloc_pub")
	}
...
func (o *FeaturelocPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no featureloc_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into featureloc_pub")
	}
...
func (o *FeaturelocPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update featureloc_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update featureloc_pub row")
	}
...
func (q featurelocPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for featureloc_pub")
	}
...
func (o FeaturelocPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featurelocPub slice")
	}
...
func (o *FeaturelocPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no featureloc_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert featureloc_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for featureloc_pub")
	}
...
func (o *FeaturelocPub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeaturelocPub provided for deletion")
	}
...
func (o *FeaturelocPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeaturelocPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from featureloc_pub")
	}
...
func (q featurelocPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featurelocPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureloc_pub")
	}
...
func (o FeaturelocPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeaturelocPub slice provided for delete all")
	}
...
func (o FeaturelocPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featurelocPub slice")
	}
...
func (o *FeaturelocPub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeaturelocPub provided for reload")
	}
...
func (o *FeaturelocPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeaturelocPubSlice provided for reload all")
	}
...
func (o *FeaturelocPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeaturelocPubSlice")
	}
...
func FeaturelocPubExists(exec boil.Executor, featurelocPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if featureloc_pub exists")
	}
