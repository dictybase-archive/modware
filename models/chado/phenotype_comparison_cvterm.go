...
func (q phenotypeComparisonCvtermQuery) One() (*PhenotypeComparisonCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for phenotype_comparison_cvterm")
	}
...
func (q phenotypeComparisonCvtermQuery) All() (PhenotypeComparisonCvtermSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to PhenotypeComparisonCvterm slice")
	}
...
func FindPhenotypeComparisonCvterm(exec boil.Executor, phenotypeComparisonCvtermID int, selectCols ...string) (*PhenotypeComparisonCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from phenotype_comparison_cvterm")
	}
...
func (o *PhenotypeComparisonCvterm) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no phenotype_comparison_cvterm provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into phenotype_comparison_cvterm")
	}
...
func (o *PhenotypeComparisonCvterm) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update phenotype_comparison_cvterm, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update phenotype_comparison_cvterm row")
	}
...
func (o PhenotypeComparisonCvtermSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in phenotypeComparisonCvterm slice")
	}
...
func (o *PhenotypeComparisonCvterm) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no phenotype_comparison_cvterm provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert phenotype_comparison_cvterm, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for phenotype_comparison_cvterm")
	}
...
func (o *PhenotypeComparisonCvterm) DeleteG() error {
	if o == nil {
		return errors.New("chado: no PhenotypeComparisonCvterm provided for deletion")
	}
...
func (o *PhenotypeComparisonCvterm) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no PhenotypeComparisonCvterm provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from phenotype_comparison_cvterm")
	}
...
func (o PhenotypeComparisonCvtermSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no PhenotypeComparisonCvterm slice provided for delete all")
	}
...
func (o PhenotypeComparisonCvtermSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from phenotypeComparisonCvterm slice")
	}
...
func (o *PhenotypeComparisonCvterm) ReloadG() error {
	if o == nil {
		return errors.New("chado: no PhenotypeComparisonCvterm provided for reload")
	}
...
func (o *PhenotypeComparisonCvtermSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty PhenotypeComparisonCvtermSlice provided for reload all")
	}
