...
func (q genotypepropQuery) One() (*Genotypeprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for genotypeprop")
	}
...
func (q genotypepropQuery) All() (GenotypepropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Genotypeprop slice")
	}
...
func (q genotypepropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count genotypeprop rows")
	}
...
func (q genotypepropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if genotypeprop exists")
	}
...
func FindGenotypeprop(exec boil.Executor, genotypepropID int, selectCols ...string) (*Genotypeprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from genotypeprop")
	}
...
func (o *Genotypeprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no genotypeprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into genotypeprop")
	}
...
func (o *Genotypeprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update genotypeprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update genotypeprop row")
	}
...
func (q genotypepropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for genotypeprop")
	}
...
func (o GenotypepropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in genotypeprop slice")
	}
...
func (o *Genotypeprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no genotypeprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert genotypeprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for genotypeprop")
	}
...
func (o *Genotypeprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Genotypeprop provided for deletion")
	}
...
func (o *Genotypeprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Genotypeprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from genotypeprop")
	}
...
func (q genotypepropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no genotypepropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from genotypeprop")
	}
...
func (o GenotypepropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Genotypeprop slice provided for delete all")
	}
...
func (o GenotypepropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from genotypeprop slice")
	}
...
func (o *Genotypeprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Genotypeprop provided for reload")
	}
...
func (o *GenotypepropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty GenotypepropSlice provided for reload all")
	}
...
func (o *GenotypepropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in GenotypepropSlice")
	}
...
func GenotypepropExists(exec boil.Executor, genotypepropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if genotypeprop exists")
	}
