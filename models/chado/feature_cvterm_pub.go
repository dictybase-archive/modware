...
func (q featureCvtermPubQuery) One() (*FeatureCvtermPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature_cvterm_pub")
	}
...
func (q featureCvtermPubQuery) All() (FeatureCvtermPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeatureCvtermPub slice")
	}
...
func (q featureCvtermPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_cvterm_pub rows")
	}
...
func (q featureCvtermPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature_cvterm_pub exists")
	}
...
func FindFeatureCvtermPub(exec boil.Executor, featureCvtermPubID int, selectCols ...string) (*FeatureCvtermPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_cvterm_pub")
	}
...
func (o *FeatureCvtermPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_cvterm_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_cvterm_pub")
	}
...
func (o *FeatureCvtermPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature_cvterm_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature_cvterm_pub row")
	}
...
func (q featureCvtermPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_cvterm_pub")
	}
...
func (o FeatureCvtermPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureCvtermPub slice")
	}
...
func (o *FeatureCvtermPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_cvterm_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature_cvterm_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature_cvterm_pub")
	}
...
func (o *FeatureCvtermPub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermPub provided for deletion")
	}
...
func (o *FeatureCvtermPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature_cvterm_pub")
	}
...
func (q featureCvtermPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featureCvtermPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature_cvterm_pub")
	}
...
func (o FeatureCvtermPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermPub slice provided for delete all")
	}
...
func (o FeatureCvtermPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureCvtermPub slice")
	}
...
func (o *FeatureCvtermPub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermPub provided for reload")
	}
...
func (o *FeatureCvtermPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeatureCvtermPubSlice provided for reload all")
	}
...
func (o *FeatureCvtermPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeatureCvtermPubSlice")
	}
...
func FeatureCvtermPubExists(exec boil.Executor, featureCvtermPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_cvterm_pub exists")
	}
