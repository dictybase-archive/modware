...
func (q organismQuery) One() (*Organism, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for organism")
	}
...
func (q organismQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count organism rows")
	}
...
func FindOrganism(exec boil.Executor, organismID int, selectCols ...string) (*Organism, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from organism")
	}
...
func (o *Organism) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no organism provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into organism")
	}
...
func (o OrganismSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in organism slice")
	}
...
func (o *OrganismSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty OrganismSlice provided for reload all")
	}
...
func (o *OrganismSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in OrganismSlice")
	}
