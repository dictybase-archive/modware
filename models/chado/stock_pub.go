...
func (q stockPubQuery) One() (*StockPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_pub")
	}
...
func (q stockPubQuery) All() (StockPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockPub slice")
	}
...
func (q stockPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_pub rows")
	}
...
func FindStockPub(exec boil.Executor, stockPubID int, selectCols ...string) (*StockPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_pub")
	}
...
func (o *StockPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_pub")
	}
...
func (o *StockPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_pub row")
	}
...
func (q stockPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_pub")
	}
...
func (o StockPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockPub slice")
	}
...
func (o *StockPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_pub")
	}
...
func (o *StockPub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockPub provided for deletion")
	}
...
func (o *StockPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_pub")
	}
...
func (q stockPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_pub")
	}
...
func (o StockPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockPub slice provided for delete all")
	}
...
func (o StockPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockPub slice")
	}
...
func (o *StockPub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockPub provided for reload")
	}
...
func (o *StockPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockPubSlice provided for reload all")
	}
...
func (o *StockPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockPubSlice")
	}
