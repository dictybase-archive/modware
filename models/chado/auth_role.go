...
func (q authRoleQuery) One() (*AuthRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for auth_role")
	}
...
func (q authRoleQuery) All() (AuthRoleSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to AuthRole slice")
	}
...
func (q authRoleQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count auth_role rows")
	}
...
func (q authRoleQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if auth_role exists")
	}
...
func FindAuthRole(exec boil.Executor, authRoleID int, selectCols ...string) (*AuthRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from auth_role")
	}
...
func (o *AuthRole) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no auth_role provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into auth_role")
	}
...
func (o *AuthRole) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update auth_role, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update auth_role row")
	}
...
func (q authRoleQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for auth_role")
	}
...
func (o AuthRoleSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in authRole slice")
	}
...
func (o *AuthRole) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no auth_role provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert auth_role, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for auth_role")
	}
...
func (o *AuthRole) DeleteG() error {
	if o == nil {
		return errors.New("chado: no AuthRole provided for deletion")
	}
...
func (o *AuthRole) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no AuthRole provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from auth_role")
	}
...
func (q authRoleQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no authRoleQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from auth_role")
	}
...
func (o AuthRoleSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no AuthRole slice provided for delete all")
	}
...
func (o AuthRoleSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from authRole slice")
	}
...
func (o *AuthRole) ReloadG() error {
	if o == nil {
		return errors.New("chado: no AuthRole provided for reload")
	}
...
func (o *AuthRoleSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty AuthRoleSlice provided for reload all")
	}
...
func (o *AuthRoleSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in AuthRoleSlice")
	}
...
func AuthRoleExists(exec boil.Executor, authRoleID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if auth_role exists")
	}
