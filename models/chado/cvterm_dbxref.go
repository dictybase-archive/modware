...
func (o *CvtermDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no cvterm_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into cvterm_dbxref")
	}
...
func (o *CvtermDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update cvterm_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update cvterm_dbxref row")
	}
...
func (o CvtermDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in cvtermDbxref slice")
	}
...
func (o *CvtermDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no cvterm_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert cvterm_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for cvterm_dbxref")
	}
...
func (o *CvtermDbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no CvtermDbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from cvterm_dbxref")
	}
...
func (o CvtermDbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no CvtermDbxref slice provided for delete all")
	}
...
func (o CvtermDbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from cvtermDbxref slice")
	}
...
func (o *CvtermDbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in CvtermDbxrefSlice")
	}
...
func CvtermDbxrefExists(exec boil.Executor, cvtermDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if cvterm_dbxref exists")
	}
