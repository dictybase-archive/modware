...
func (q pubQuery) One() (*Pub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for pub")
	}
...
func (q pubQuery) All() (PubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Pub slice")
	}
...
func (q pubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count pub rows")
	}
...
func (q pubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if pub exists")
	}
...
func FindPub(exec boil.Executor, pubID int, selectCols ...string) (*Pub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from pub")
	}
...
func (o *Pub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into pub")
	}
...
func (o *Pub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update pub row")
	}
...
func (q pubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for pub")
	}
...
func (o PubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in pub slice")
	}
...
func (o *Pub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for pub")
	}
...
func (o *Pub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Pub provided for deletion")
	}
...
func (o *Pub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Pub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from pub")
	}
...
func (q pubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no pubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from pub")
	}
...
func (o PubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Pub slice provided for delete all")
	}
...
func (o PubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from pub slice")
	}
...
func (o *Pub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Pub provided for reload")
	}
...
func (o *PubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty PubSlice provided for reload all")
	}
...
func (o *PubSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&pubs)
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in PubSlice")
	}
...
func PubExists(exec boil.Executor, pubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if pub exists")
	}
