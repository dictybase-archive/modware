...
func (q featurepropQuery) One() (*Featureprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for featureprop")
	}
...
func (q featurepropQuery) All() (FeaturepropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to Featureprop slice")
	}
...
func (q featurepropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count featureprop rows")
	}
...
func (q featurepropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if featureprop exists")
	}
...
func FindFeatureprop(exec boil.Executor, featurepropID int, selectCols ...string) (*Featureprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from featureprop")
	}
...
func (o *Featureprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no featureprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into featureprop")
	}
...
func (o *Featureprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update featureprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update featureprop row")
	}
...
func (q featurepropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for featureprop")
	}
...
func (o FeaturepropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureprop slice")
	}
...
func (o *Featureprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no featureprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert featureprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for featureprop")
	}
...
func (o *Featureprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no Featureprop provided for deletion")
	}
...
func (o *Featureprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Featureprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from featureprop")
	}
...
func (q featurepropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featurepropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureprop")
	}
...
func (o FeaturepropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Featureprop slice provided for delete all")
	}
...
func (o FeaturepropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureprop slice")
	}
...
func (o *Featureprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no Featureprop provided for reload")
	}
...
func (o *FeaturepropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeaturepropSlice provided for reload all")
	}
...
func (o *FeaturepropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeaturepropSlice")
	}
...
func FeaturepropExists(exec boil.Executor, featurepropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if featureprop exists")
	}
