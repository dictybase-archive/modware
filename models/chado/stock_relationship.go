...
func (q stockRelationshipQuery) One() (*StockRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_relationship")
	}
...
func (q stockRelationshipQuery) All() (StockRelationshipSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockRelationship slice")
	}
...
func (q stockRelationshipQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_relationship rows")
	}
...
func FindStockRelationship(exec boil.Executor, stockRelationshipID int, selectCols ...string) (*StockRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_relationship")
	}
...
func (o *StockRelationship) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_relationship provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_relationship")
	}
...
func (o *StockRelationship) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_relationship, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_relationship row")
	}
...
func (q stockRelationshipQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_relationship")
	}
...
func (o StockRelationshipSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockRelationship slice")
	}
...
func (o *StockRelationship) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_relationship provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_relationship, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_relationship")
	}
...
func (o *StockRelationship) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockRelationship provided for deletion")
	}
...
func (o *StockRelationship) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockRelationship provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_relationship")
	}
...
func (q stockRelationshipQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockRelationshipQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_relationship")
	}
...
func (o StockRelationshipSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockRelationship slice provided for delete all")
	}
...
func (o StockRelationshipSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockRelationship slice")
	}
...
func (o *StockRelationship) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockRelationship provided for reload")
	}
...
func (o *StockRelationshipSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockRelationshipSlice provided for reload all")
	}
...
func (o *StockRelationshipSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockRelationshipSlice")
	}
