...
func (q stockRelationshipPubQuery) One() (*StockRelationshipPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for stock_relationship_pub")
	}
...
func (q stockRelationshipPubQuery) All() (StockRelationshipPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to StockRelationshipPub slice")
	}
...
func (q stockRelationshipPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count stock_relationship_pub rows")
	}
...
func (q stockRelationshipPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if stock_relationship_pub exists")
	}
...
func FindStockRelationshipPub(exec boil.Executor, stockRelationshipPubID int, selectCols ...string) (*StockRelationshipPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from stock_relationship_pub")
	}
...
func (o *StockRelationshipPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_relationship_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into stock_relationship_pub")
	}
...
func (o *StockRelationshipPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update stock_relationship_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update stock_relationship_pub row")
	}
...
func (q stockRelationshipPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for stock_relationship_pub")
	}
...
func (o StockRelationshipPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in stockRelationshipPub slice")
	}
...
func (o *StockRelationshipPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no stock_relationship_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert stock_relationship_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for stock_relationship_pub")
	}
...
func (o *StockRelationshipPub) DeleteG() error {
	if o == nil {
		return errors.New("chado: no StockRelationshipPub provided for deletion")
	}
...
func (o *StockRelationshipPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no StockRelationshipPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from stock_relationship_pub")
	}
...
func (q stockRelationshipPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no stockRelationshipPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stock_relationship_pub")
	}
...
func (o StockRelationshipPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no StockRelationshipPub slice provided for delete all")
	}
...
func (o StockRelationshipPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from stockRelationshipPub slice")
	}
...
func (o *StockRelationshipPub) ReloadG() error {
	if o == nil {
		return errors.New("chado: no StockRelationshipPub provided for reload")
	}
...
func (o *StockRelationshipPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty StockRelationshipPubSlice provided for reload all")
	}
...
func (o *StockRelationshipPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in StockRelationshipPubSlice")
	}
...
func StockRelationshipPubExists(exec boil.Executor, stockRelationshipPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if stock_relationship_pub exists")
	}
