...
func (q featurePubpropQuery) One() (*FeaturePubprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature_pubprop")
	}
...
func (q featurePubpropQuery) All() (FeaturePubpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeaturePubprop slice")
	}
...
func (q featurePubpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_pubprop rows")
	}
...
func (q featurePubpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature_pubprop exists")
	}
...
func FindFeaturePubprop(exec boil.Executor, featurePubpropID int, selectCols ...string) (*FeaturePubprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_pubprop")
	}
...
func (o *FeaturePubprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_pubprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_pubprop")
	}
...
func (o *FeaturePubprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature_pubprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature_pubprop row")
	}
...
func (q featurePubpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_pubprop")
	}
...
func (o FeaturePubpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featurePubprop slice")
	}
...
func (o *FeaturePubprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_pubprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature_pubprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature_pubprop")
	}
...
func (o *FeaturePubprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeaturePubprop provided for deletion")
	}
...
func (o *FeaturePubprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeaturePubprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature_pubprop")
	}
...
func (q featurePubpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featurePubpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature_pubprop")
	}
...
func (o FeaturePubpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeaturePubprop slice provided for delete all")
	}
...
func (o FeaturePubpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featurePubprop slice")
	}
...
func (o *FeaturePubprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeaturePubprop provided for reload")
	}
...
func (o *FeaturePubpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeaturePubpropSlice provided for reload all")
	}
...
func (o *FeaturePubpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeaturePubpropSlice")
	}
...
func FeaturePubpropExists(exec boil.Executor, featurePubpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_pubprop exists")
	}
