...
func (q tableinfoQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if tableinfo exists")
	}
...
func (o *Tableinfo) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no tableinfo provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into tableinfo")
	}
...
func (o *Tableinfo) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update tableinfo, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update tableinfo row")
	}
...
func (o TableinfoSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in tableinfo slice")
	}
...
func (o *Tableinfo) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no tableinfo provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert tableinfo, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for tableinfo")
	}
...
func (o *Tableinfo) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no Tableinfo provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from tableinfo")
	}
...
func (o TableinfoSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no Tableinfo slice provided for delete all")
	}
...
func (o TableinfoSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from tableinfo slice")
	}
...
func (o *TableinfoSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in TableinfoSlice")
	}
