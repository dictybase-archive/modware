...
func (q featureRelationshippropQuery) One() (*FeatureRelationshipprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature_relationshipprop")
	}
...
func (q featureRelationshippropQuery) All() (FeatureRelationshippropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeatureRelationshipprop slice")
	}
...
func (q featureRelationshippropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_relationshipprop rows")
	}
...
func (q featureRelationshippropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature_relationshipprop exists")
	}
...
func FindFeatureRelationshipprop(exec boil.Executor, featureRelationshippropID int, selectCols ...string) (*FeatureRelationshipprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_relationshipprop")
	}
...
func (o *FeatureRelationshipprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_relationshipprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_relationshipprop")
	}
...
func (o *FeatureRelationshipprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature_relationshipprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature_relationshipprop row")
	}
...
func (q featureRelationshippropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_relationshipprop")
	}
...
func (o FeatureRelationshippropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureRelationshipprop slice")
	}
...
func (o *FeatureRelationshipprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_relationshipprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature_relationshipprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature_relationshipprop")
	}
...
func (o *FeatureRelationshipprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeatureRelationshipprop provided for deletion")
	}
...
func (o *FeatureRelationshipprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeatureRelationshipprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature_relationshipprop")
	}
...
func (q featureRelationshippropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featureRelationshippropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature_relationshipprop")
	}
...
func (o FeatureRelationshippropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeatureRelationshipprop slice provided for delete all")
	}
...
func (o FeatureRelationshippropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureRelationshipprop slice")
	}
...
func (o *FeatureRelationshipprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeatureRelationshipprop provided for reload")
	}
...
func (o *FeatureRelationshippropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeatureRelationshippropSlice provided for reload all")
	}
...
func (o *FeatureRelationshippropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeatureRelationshippropSlice")
	}
...
func FeatureRelationshippropExists(exec boil.Executor, featureRelationshippropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_relationshipprop exists")
	}
