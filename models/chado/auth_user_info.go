...
func (q authUserInfoQuery) One() (*AuthUserInfo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for auth_user_info")
	}
...
func (q authUserInfoQuery) All() (AuthUserInfoSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to AuthUserInfo slice")
	}
...
func (q authUserInfoQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count auth_user_info rows")
	}
...
func (q authUserInfoQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if auth_user_info exists")
	}
...
func FindAuthUserInfo(exec boil.Executor, authUserInfoID int, selectCols ...string) (*AuthUserInfo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from auth_user_info")
	}
...
func (o *AuthUserInfo) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no auth_user_info provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into auth_user_info")
	}
...
func (o *AuthUserInfo) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update auth_user_info, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update auth_user_info row")
	}
...
func (q authUserInfoQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for auth_user_info")
	}
...
func (o AuthUserInfoSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in authUserInfo slice")
	}
...
func (o *AuthUserInfo) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no auth_user_info provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert auth_user_info, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for auth_user_info")
	}
...
func (o *AuthUserInfo) DeleteG() error {
	if o == nil {
		return errors.New("chado: no AuthUserInfo provided for deletion")
	}
...
func (o *AuthUserInfo) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no AuthUserInfo provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from auth_user_info")
	}
...
func (q authUserInfoQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no authUserInfoQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from auth_user_info")
	}
...
func (o AuthUserInfoSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no AuthUserInfo slice provided for delete all")
	}
...
func (o AuthUserInfoSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from authUserInfo slice")
	}
...
func (o *AuthUserInfo) ReloadG() error {
	if o == nil {
		return errors.New("chado: no AuthUserInfo provided for reload")
	}
...
func (o *AuthUserInfoSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty AuthUserInfoSlice provided for reload all")
	}
...
func (o *AuthUserInfoSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in AuthUserInfoSlice")
	}
...
func AuthUserInfoExists(exec boil.Executor, authUserInfoID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if auth_user_info exists")
	}
