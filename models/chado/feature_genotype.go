...
func (q featureGenotypeQuery) One() (*FeatureGenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature_genotype")
	}
...
func (q featureGenotypeQuery) All() (FeatureGenotypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeatureGenotype slice")
	}
...
func (q featureGenotypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_genotype rows")
	}
...
func (q featureGenotypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature_genotype exists")
	}
...
func FindFeatureGenotype(exec boil.Executor, featureGenotypeID int, selectCols ...string) (*FeatureGenotype, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_genotype")
	}
...
func (o *FeatureGenotype) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_genotype provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_genotype")
	}
...
func (o *FeatureGenotype) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("chado: unable to update feature_genotype, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update feature_genotype row")
	}
...
func (q featureGenotypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_genotype")
	}
...
func (o FeatureGenotypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureGenotype slice")
	}
...
func (o *FeatureGenotype) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_genotype provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("chado: unable to upsert feature_genotype, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to upsert for feature_genotype")
	}
...
func (o *FeatureGenotype) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeatureGenotype provided for deletion")
	}
...
func (o *FeatureGenotype) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeatureGenotype provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature_genotype")
	}
...
func (q featureGenotypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featureGenotypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature_genotype")
	}
...
func (o FeatureGenotypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeatureGenotype slice provided for delete all")
	}
...
func (o FeatureGenotypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureGenotype slice")
	}
...
func (o *FeatureGenotype) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeatureGenotype provided for reload")
	}
...
func (o *FeatureGenotypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeatureGenotypeSlice provided for reload all")
	}
...
func (o *FeatureGenotypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeatureGenotypeSlice")
	}
...
func FeatureGenotypeExists(exec boil.Executor, featureGenotypeID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_genotype exists")
	}
