...
func (q featureCvtermpropQuery) One() (*FeatureCvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: failed to execute a one query for feature_cvtermprop")
	}
...
func (q featureCvtermpropQuery) All() (FeatureCvtermpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "chado: failed to assign all query results to FeatureCvtermprop slice")
	}
...
func (q featureCvtermpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "chado: failed to count feature_cvtermprop rows")
	}
...
func (q featureCvtermpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "chado: failed to check if feature_cvtermprop exists")
	}
...
func FindFeatureCvtermprop(exec boil.Executor, featureCvtermpropID int, selectCols ...string) (*FeatureCvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "chado: unable to select from feature_cvtermprop")
	}
...
func (o *FeatureCvtermprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("chado: no feature_cvtermprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to insert into feature_cvtermprop")
	}
...
func (q featureCvtermpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all for feature_cvtermprop")
	}
...
func (o FeatureCvtermpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to update all in featureCvtermprop slice")
	}
...
func (o *FeatureCvtermprop) DeleteG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermprop provided for deletion")
	}
...
func (o *FeatureCvtermprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete from feature_cvtermprop")
	}
...
func (q featureCvtermpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("chado: no featureCvtermpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from feature_cvtermprop")
	}
...
func (o FeatureCvtermpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermprop slice provided for delete all")
	}
...
func (o FeatureCvtermpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "chado: unable to delete all from featureCvtermprop slice")
	}
...
func (o *FeatureCvtermprop) ReloadG() error {
	if o == nil {
		return errors.New("chado: no FeatureCvtermprop provided for reload")
	}
...
func (o *FeatureCvtermpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("chado: empty FeatureCvtermpropSlice provided for reload all")
	}
...
func (o *FeatureCvtermpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "chado: unable to reload all in FeatureCvtermpropSlice")
	}
...
func FeatureCvtermpropExists(exec boil.Executor, featureCvtermpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "chado: unable to check if feature_cvtermprop exists")
	}
