...
func (q featureRelationshipPubQuery) One() (*FeatureRelationshipPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_relationship_pub")
	}
...
func (q featureRelationshipPubQuery) All() (FeatureRelationshipPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeatureRelationshipPub slice")
	}
...
func (q featureRelationshipPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_relationship_pub rows")
	}
...
func (q featureRelationshipPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_relationship_pub exists")
	}
...
func FindFeatureRelationshipPub(exec boil.Executor, featureRelationshipPubID int, selectCols ...string) (*FeatureRelationshipPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_relationship_pub")
	}
...
func (o *FeatureRelationshipPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_relationship_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_relationship_pub")
	}
...
func (o *FeatureRelationshipPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_relationship_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_relationship_pub row")
	}
...
func (q featureRelationshipPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_relationship_pub")
	}
...
func (o FeatureRelationshipPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureRelationshipPub slice")
	}
...
func (o *FeatureRelationshipPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_relationship_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_relationship_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_relationship_pub")
	}
...
func (o *FeatureRelationshipPub) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationshipPub provided for deletion")
	}
...
func (o *FeatureRelationshipPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeatureRelationshipPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_relationship_pub")
	}
...
func (q featureRelationshipPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featureRelationshipPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_relationship_pub")
	}
...
func (o FeatureRelationshipPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationshipPub slice provided for delete all")
	}
...
func (o FeatureRelationshipPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureRelationshipPub slice")
	}
...
func (o *FeatureRelationshipPub) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeatureRelationshipPub provided for reload")
	}
...
func (o *FeatureRelationshipPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeatureRelationshipPubSlice provided for reload all")
	}
...
func (o *FeatureRelationshipPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeatureRelationshipPubSlice")
	}
...
func FeatureRelationshipPubExists(exec boil.Executor, featureRelationshipPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_relationship_pub exists")
	}
