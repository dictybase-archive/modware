...
func (q analysispropQuery) One() (*Analysisprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for analysisprop")
	}
...
func (q analysispropQuery) All() (AnalysispropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Analysisprop slice")
	}
...
func (q analysispropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count analysisprop rows")
	}
...
func (q analysispropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if analysisprop exists")
	}
...
func FindAnalysisprop(exec boil.Executor, analysispropID int, selectCols ...string) (*Analysisprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from analysisprop")
	}
...
func (o *Analysisprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into analysisprop")
	}
...
func (o *Analysisprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update analysisprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update analysisprop row")
	}
...
func (q analysispropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for analysisprop")
	}
...
func (o AnalysispropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in analysisprop slice")
	}
...
func (o *Analysisprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no analysisprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert analysisprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for analysisprop")
	}
...
func (o *Analysisprop) DeleteG() error {
	if o == nil {
		return errors.New("models: no Analysisprop provided for deletion")
	}
...
func (o *Analysisprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Analysisprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from analysisprop")
	}
...
func (q analysispropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no analysispropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisprop")
	}
...
func (o AnalysispropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Analysisprop slice provided for delete all")
	}
...
func (o AnalysispropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from analysisprop slice")
	}
...
func (o *Analysisprop) ReloadG() error {
	if o == nil {
		return errors.New("models: no Analysisprop provided for reload")
	}
...
func (o *AnalysispropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AnalysispropSlice provided for reload all")
	}
...
func (o *AnalysispropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in AnalysispropSlice")
	}
...
func AnalysispropExists(exec boil.Executor, analysispropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if analysisprop exists")
	}
