...
func (q featureDbxrefQuery) One() (*FeatureDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_dbxref")
	}
...
func (q featureDbxrefQuery) All() (FeatureDbxrefSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeatureDbxref slice")
	}
...
func (q featureDbxrefQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_dbxref rows")
	}
...
func (q featureDbxrefQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_dbxref exists")
	}
...
func FindFeatureDbxref(exec boil.Executor, featureDbxrefID int, selectCols ...string) (*FeatureDbxref, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_dbxref")
	}
...
func (o *FeatureDbxref) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_dbxref provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_dbxref")
	}
...
func (o *FeatureDbxref) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_dbxref, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_dbxref row")
	}
...
func (q featureDbxrefQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_dbxref")
	}
...
func (o FeatureDbxrefSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureDbxref slice")
	}
...
func (o *FeatureDbxref) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_dbxref provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_dbxref, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_dbxref")
	}
...
func (o *FeatureDbxref) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeatureDbxref provided for deletion")
	}
...
func (o *FeatureDbxref) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeatureDbxref provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_dbxref")
	}
...
func (q featureDbxrefQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featureDbxrefQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_dbxref")
	}
...
func (o FeatureDbxrefSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeatureDbxref slice provided for delete all")
	}
...
func (o FeatureDbxrefSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureDbxref slice")
	}
...
func (o *FeatureDbxref) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeatureDbxref provided for reload")
	}
...
func (o *FeatureDbxrefSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeatureDbxrefSlice provided for reload all")
	}
...
func (o *FeatureDbxrefSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeatureDbxrefSlice")
	}
...
func FeatureDbxrefExists(exec boil.Executor, featureDbxrefID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_dbxref exists")
	}
