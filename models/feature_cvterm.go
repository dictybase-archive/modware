...
func (q featureCvtermQuery) One() (*FeatureCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_cvterm")
	}
...
func (q featureCvtermQuery) All() (FeatureCvtermSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeatureCvterm slice")
	}
...
func (q featureCvtermQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_cvterm rows")
	}
...
func (q featureCvtermQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_cvterm exists")
	}
...
func FindFeatureCvterm(exec boil.Executor, featureCvtermID int, selectCols ...string) (*FeatureCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_cvterm")
	}
...
func (o *FeatureCvterm) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_cvterm provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_cvterm")
	}
...
func (o *FeatureCvterm) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_cvterm, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_cvterm row")
	}
...
func (q featureCvtermQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_cvterm")
	}
...
func (o FeatureCvtermSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureCvterm slice")
	}
...
func (o *FeatureCvterm) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_cvterm provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_cvterm, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_cvterm")
	}
...
func (o *FeatureCvterm) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeatureCvterm provided for deletion")
	}
...
func (o *FeatureCvterm) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeatureCvterm provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_cvterm")
	}
...
func (q featureCvtermQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featureCvtermQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_cvterm")
	}
...
func (o FeatureCvtermSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeatureCvterm slice provided for delete all")
	}
...
func (o FeatureCvtermSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureCvterm slice")
	}
...
func (o *FeatureCvterm) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeatureCvterm provided for reload")
	}
...
func (o *FeatureCvtermSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeatureCvtermSlice provided for reload all")
	}
...
func (o *FeatureCvtermSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeatureCvtermSlice")
	}
...
func FeatureCvtermExists(exec boil.Executor, featureCvtermID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_cvterm exists")
	}
