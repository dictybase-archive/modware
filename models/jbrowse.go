...
func (q jbrowseQuery) One() (*Jbrowse, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for jbrowse")
	}
...
func (q jbrowseQuery) All() (JbrowseSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Jbrowse slice")
	}
...
func (q jbrowseQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count jbrowse rows")
	}
...
func (q jbrowseQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if jbrowse exists")
	}
...
func FindJbrowse(exec boil.Executor, jbrowseID int, selectCols ...string) (*Jbrowse, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from jbrowse")
	}
...
func (o *Jbrowse) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no jbrowse provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into jbrowse")
	}
...
func (o *Jbrowse) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update jbrowse, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update jbrowse row")
	}
...
func (q jbrowseQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for jbrowse")
	}
...
func (o JbrowseSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in jbrowse slice")
	}
...
func (o *Jbrowse) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no jbrowse provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert jbrowse, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for jbrowse")
	}
...
func (o *Jbrowse) DeleteG() error {
	if o == nil {
		return errors.New("models: no Jbrowse provided for deletion")
	}
...
func (o *Jbrowse) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Jbrowse provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from jbrowse")
	}
...
func (q jbrowseQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no jbrowseQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from jbrowse")
	}
...
func (o JbrowseSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Jbrowse slice provided for delete all")
	}
...
func (o JbrowseSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from jbrowse slice")
	}
...
func (o *Jbrowse) ReloadG() error {
	if o == nil {
		return errors.New("models: no Jbrowse provided for reload")
	}
...
func (o *JbrowseSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty JbrowseSlice provided for reload all")
	}
...
func (o *JbrowseSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&jbrowses)
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in JbrowseSlice")
	}
...
func JbrowseExists(exec boil.Executor, jbrowseID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if jbrowse exists")
	}
