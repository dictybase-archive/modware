...
func (q cvtermpathQuery) One() (*Cvtermpath, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for cvtermpath")
	}
...
func (q cvtermpathQuery) All() (CvtermpathSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Cvtermpath slice")
	}
...
func (q cvtermpathQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count cvtermpath rows")
	}
...
func (q cvtermpathQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if cvtermpath exists")
	}
...
func FindCvtermpath(exec boil.Executor, cvtermpathID int, selectCols ...string) (*Cvtermpath, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from cvtermpath")
	}
...
func (o *Cvtermpath) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermpath provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into cvtermpath")
	}
...
func (o *Cvtermpath) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update cvtermpath, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update cvtermpath row")
	}
...
func (q cvtermpathQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for cvtermpath")
	}
...
func (o CvtermpathSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in cvtermpath slice")
	}
...
func (o *Cvtermpath) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermpath provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert cvtermpath, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for cvtermpath")
	}
...
func (o *Cvtermpath) DeleteG() error {
	if o == nil {
		return errors.New("models: no Cvtermpath provided for deletion")
	}
...
func (o *Cvtermpath) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Cvtermpath provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from cvtermpath")
	}
...
func (q cvtermpathQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no cvtermpathQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermpath")
	}
...
func (o CvtermpathSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Cvtermpath slice provided for delete all")
	}
...
func (o CvtermpathSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermpath slice")
	}
...
func (o *Cvtermpath) ReloadG() error {
	if o == nil {
		return errors.New("models: no Cvtermpath provided for reload")
	}
...
func (o *CvtermpathSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CvtermpathSlice provided for reload all")
	}
...
func (o *CvtermpathSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CvtermpathSlice")
	}
...
func CvtermpathExists(exec boil.Executor, cvtermpathID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if cvtermpath exists")
	}
