...
func (q featurepropPubQuery) One() (*FeaturepropPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for featureprop_pub")
	}
...
func (q featurepropPubQuery) All() (FeaturepropPubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeaturepropPub slice")
	}
...
func (q featurepropPubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count featureprop_pub rows")
	}
...
func (q featurepropPubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if featureprop_pub exists")
	}
...
func FindFeaturepropPub(exec boil.Executor, featurepropPubID int, selectCols ...string) (*FeaturepropPub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from featureprop_pub")
	}
...
func (o *FeaturepropPub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no featureprop_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into featureprop_pub")
	}
...
func (o *FeaturepropPub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update featureprop_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update featureprop_pub row")
	}
...
func (q featurepropPubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for featureprop_pub")
	}
...
func (o FeaturepropPubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featurepropPub slice")
	}
...
func (o *FeaturepropPub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no featureprop_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert featureprop_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for featureprop_pub")
	}
...
func (o *FeaturepropPub) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeaturepropPub provided for deletion")
	}
...
func (o *FeaturepropPub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeaturepropPub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from featureprop_pub")
	}
...
func (q featurepropPubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featurepropPubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureprop_pub")
	}
...
func (o FeaturepropPubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeaturepropPub slice provided for delete all")
	}
...
func (o FeaturepropPubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featurepropPub slice")
	}
...
func (o *FeaturepropPub) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeaturepropPub provided for reload")
	}
...
func (o *FeaturepropPubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeaturepropPubSlice provided for reload all")
	}
...
func (o *FeaturepropPubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeaturepropPubSlice")
	}
...
func FeaturepropPubExists(exec boil.Executor, featurepropPubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if featureprop_pub exists")
	}
