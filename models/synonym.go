...
func (q synonymQuery) One() (*Synonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for synonym")
	}
...
func (q synonymQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count synonym rows")
	}
...
func (q synonymQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if synonym exists")
	}
...
func FindSynonym(exec boil.Executor, synonymID int, selectCols ...string) (*Synonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from synonym")
	}
...
func (o *Synonym) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no synonym provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into synonym")
	}
...
func (o *Synonym) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update synonym, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update synonym row")
	}
...
func (q synonymQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for synonym")
	}
...
func (o SynonymSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in synonym slice")
	}
...
func (o *Synonym) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no synonym provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert synonym, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for synonym")
	}
...
func (o *Synonym) DeleteG() error {
	if o == nil {
		return errors.New("models: no Synonym provided for deletion")
	}
...
func (o *Synonym) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Synonym provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from synonym")
	}
...
func (q synonymQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no synonymQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from synonym")
	}
...
func (o SynonymSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Synonym slice provided for delete all")
	}
...
func (o SynonymSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from synonym slice")
	}
...
func (o *Synonym) ReloadG() error {
	if o == nil {
		return errors.New("models: no Synonym provided for reload")
	}
...
func (o *SynonymSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty SynonymSlice provided for reload all")
	}
...
func SynonymExists(exec boil.Executor, synonymID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if synonym exists")
	}
