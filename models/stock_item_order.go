...
func (q stockItemOrderQuery) One() (*StockItemOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for stock_item_order")
	}
...
func (q stockItemOrderQuery) All() (StockItemOrderSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to StockItemOrder slice")
	}
...
func (q stockItemOrderQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count stock_item_order rows")
	}
...
func (q stockItemOrderQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if stock_item_order exists")
	}
...
func FindStockItemOrder(exec boil.Executor, stockItemOrderID int, selectCols ...string) (*StockItemOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from stock_item_order")
	}
...
func (o *StockItemOrder) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_item_order provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into stock_item_order")
	}
...
func (o *StockItemOrder) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update stock_item_order, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update stock_item_order row")
	}
...
func (q stockItemOrderQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for stock_item_order")
	}
...
func (o StockItemOrderSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in stockItemOrder slice")
	}
...
func (o *StockItemOrder) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stock_item_order provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert stock_item_order, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for stock_item_order")
	}
...
func (o *StockItemOrder) DeleteG() error {
	if o == nil {
		return errors.New("models: no StockItemOrder provided for deletion")
	}
...
func (o *StockItemOrder) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no StockItemOrder provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from stock_item_order")
	}
...
func (q stockItemOrderQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no stockItemOrderQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stock_item_order")
	}
...
func (o StockItemOrderSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no StockItemOrder slice provided for delete all")
	}
...
func (o StockItemOrderSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stockItemOrder slice")
	}
...
func (o *StockItemOrder) ReloadG() error {
	if o == nil {
		return errors.New("models: no StockItemOrder provided for reload")
	}
...
func (o *StockItemOrderSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StockItemOrderSlice provided for reload all")
	}
...
func (o *StockItemOrderSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in StockItemOrderSlice")
	}
...
func StockItemOrderExists(exec boil.Executor, stockItemOrderID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if stock_item_order exists")
	}
