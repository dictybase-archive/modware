...
func (q environmentCvtermQuery) One() (*EnvironmentCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for environment_cvterm")
	}
...
func (q environmentCvtermQuery) All() (EnvironmentCvtermSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to EnvironmentCvterm slice")
	}
...
func (q environmentCvtermQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count environment_cvterm rows")
	}
...
func (q environmentCvtermQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if environment_cvterm exists")
	}
...
func FindEnvironmentCvterm(exec boil.Executor, environmentCvtermID int, selectCols ...string) (*EnvironmentCvterm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from environment_cvterm")
	}
...
func (o *EnvironmentCvterm) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no environment_cvterm provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into environment_cvterm")
	}
...
func (o *EnvironmentCvterm) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update environment_cvterm, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update environment_cvterm row")
	}
...
func (q environmentCvtermQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for environment_cvterm")
	}
...
func (o EnvironmentCvtermSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in environmentCvterm slice")
	}
...
func (o *EnvironmentCvterm) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no environment_cvterm provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert environment_cvterm, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for environment_cvterm")
	}
...
func (o *EnvironmentCvterm) DeleteG() error {
	if o == nil {
		return errors.New("models: no EnvironmentCvterm provided for deletion")
	}
...
func (o *EnvironmentCvterm) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no EnvironmentCvterm provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from environment_cvterm")
	}
...
func (q environmentCvtermQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no environmentCvtermQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from environment_cvterm")
	}
...
func (o EnvironmentCvtermSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no EnvironmentCvterm slice provided for delete all")
	}
...
func (o EnvironmentCvtermSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from environmentCvterm slice")
	}
...
func (o *EnvironmentCvterm) ReloadG() error {
	if o == nil {
		return errors.New("models: no EnvironmentCvterm provided for reload")
	}
...
func (o *EnvironmentCvtermSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty EnvironmentCvtermSlice provided for reload all")
	}
...
func (o *EnvironmentCvtermSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in EnvironmentCvtermSlice")
	}
...
func EnvironmentCvtermExists(exec boil.Executor, environmentCvtermID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if environment_cvterm exists")
	}
