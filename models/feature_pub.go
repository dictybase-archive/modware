...
func (q featurePubQuery) One() (*FeaturePub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_pub")
	}
...
func (q featurePubQuery) All() (FeaturePubSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeaturePub slice")
	}
...
func (q featurePubQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_pub rows")
	}
...
func (q featurePubQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_pub exists")
	}
...
func FindFeaturePub(exec boil.Executor, featurePubID int, selectCols ...string) (*FeaturePub, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_pub")
	}
...
func (o *FeaturePub) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_pub provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_pub")
	}
...
func (o *FeaturePub) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_pub, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_pub row")
	}
...
func (q featurePubQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_pub")
	}
...
func (o FeaturePubSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featurePub slice")
	}
...
func (o *FeaturePub) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_pub provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_pub, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_pub")
	}
...
func (o *FeaturePub) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeaturePub provided for deletion")
	}
...
func (o *FeaturePub) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeaturePub provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_pub")
	}
...
func (q featurePubQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featurePubQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_pub")
	}
...
func (o FeaturePubSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeaturePub slice provided for delete all")
	}
...
func (o FeaturePubSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featurePub slice")
	}
...
func (o *FeaturePub) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeaturePub provided for reload")
	}
...
func (o *FeaturePubSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeaturePubSlice provided for reload all")
	}
...
func (o *FeaturePubSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeaturePubSlice")
	}
...
func FeaturePubExists(exec boil.Executor, featurePubID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_pub exists")
	}
