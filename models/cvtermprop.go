...
func (q cvtermpropQuery) One() (*Cvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for cvtermprop")
	}
...
func (q cvtermpropQuery) All() (CvtermpropSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Cvtermprop slice")
	}
...
func (q cvtermpropQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count cvtermprop rows")
	}
...
func (q cvtermpropQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if cvtermprop exists")
	}
...
func FindCvtermprop(exec boil.Executor, cvtermpropID int, selectCols ...string) (*Cvtermprop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from cvtermprop")
	}
...
func (o *Cvtermprop) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermprop provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into cvtermprop")
	}
...
func (o *Cvtermprop) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update cvtermprop, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update cvtermprop row")
	}
...
func (q cvtermpropQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for cvtermprop")
	}
...
func (o CvtermpropSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in cvtermprop slice")
	}
...
func (o *Cvtermprop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvtermprop provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert cvtermprop, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for cvtermprop")
	}
...
func (o *Cvtermprop) DeleteG() error {
	if o == nil {
		return errors.New("models: no Cvtermprop provided for deletion")
	}
...
func (o *Cvtermprop) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Cvtermprop provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from cvtermprop")
	}
...
func (q cvtermpropQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no cvtermpropQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermprop")
	}
...
func (o CvtermpropSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Cvtermprop slice provided for delete all")
	}
...
func (o CvtermpropSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermprop slice")
	}
...
func (o *Cvtermprop) ReloadG() error {
	if o == nil {
		return errors.New("models: no Cvtermprop provided for reload")
	}
...
func (o *CvtermpropSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CvtermpropSlice provided for reload all")
	}
...
func (o *CvtermpropSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CvtermpropSlice")
	}
...
func CvtermpropExists(exec boil.Executor, cvtermpropID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if cvtermprop exists")
	}
