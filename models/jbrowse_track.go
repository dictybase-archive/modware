...
func (q jbrowseTrackQuery) One() (*JbrowseTrack, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for jbrowse_track")
	}
...
func (q jbrowseTrackQuery) All() (JbrowseTrackSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to JbrowseTrack slice")
	}
...
func (q jbrowseTrackQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count jbrowse_track rows")
	}
...
func (q jbrowseTrackQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if jbrowse_track exists")
	}
...
func FindJbrowseTrack(exec boil.Executor, jbrowseTrackID int, selectCols ...string) (*JbrowseTrack, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from jbrowse_track")
	}
...
func (o *JbrowseTrack) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no jbrowse_track provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into jbrowse_track")
	}
...
func (o *JbrowseTrack) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update jbrowse_track, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update jbrowse_track row")
	}
...
func (q jbrowseTrackQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for jbrowse_track")
	}
...
func (o JbrowseTrackSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in jbrowseTrack slice")
	}
...
func (o *JbrowseTrack) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no jbrowse_track provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert jbrowse_track, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for jbrowse_track")
	}
...
func (o *JbrowseTrack) DeleteG() error {
	if o == nil {
		return errors.New("models: no JbrowseTrack provided for deletion")
	}
...
func (o *JbrowseTrack) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no JbrowseTrack provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from jbrowse_track")
	}
...
func (q jbrowseTrackQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no jbrowseTrackQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from jbrowse_track")
	}
...
func (o JbrowseTrackSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no JbrowseTrack slice provided for delete all")
	}
...
func (o JbrowseTrackSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from jbrowseTrack slice")
	}
...
func (o *JbrowseTrack) ReloadG() error {
	if o == nil {
		return errors.New("models: no JbrowseTrack provided for reload")
	}
...
func (o *JbrowseTrackSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty JbrowseTrackSlice provided for reload all")
	}
...
func (o *JbrowseTrackSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in JbrowseTrackSlice")
	}
...
func JbrowseTrackExists(exec boil.Executor, jbrowseTrackID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if jbrowse_track exists")
	}
