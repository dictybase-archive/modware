...
func (o *Contact) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update contact, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update contact row")
	}
...
func (q contactQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for contact")
	}
...
func (o ContactSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contact slice")
	}
...
func (o *Contact) DeleteG() error {
	if o == nil {
		return errors.New("models: no Contact provided for deletion")
	}
...
func (o *Contact) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Contact provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from contact")
	}
...
func (q contactQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contactQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contact")
	}
...
func (o ContactSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Contact slice provided for delete all")
	}
...
func (o ContactSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contact slice")
	}
