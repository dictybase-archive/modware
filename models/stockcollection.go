...
func (q stockcollectionQuery) One() (*Stockcollection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for stockcollection")
	}
...
func (q stockcollectionQuery) All() (StockcollectionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Stockcollection slice")
	}
...
func (q stockcollectionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count stockcollection rows")
	}
...
func (q stockcollectionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if stockcollection exists")
	}
...
func FindStockcollection(exec boil.Executor, stockcollectionID int, selectCols ...string) (*Stockcollection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from stockcollection")
	}
...
func (o *Stockcollection) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stockcollection provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into stockcollection")
	}
...
func (o *Stockcollection) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update stockcollection, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update stockcollection row")
	}
...
func (q stockcollectionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for stockcollection")
	}
...
func (o StockcollectionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in stockcollection slice")
	}
...
func (o *Stockcollection) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no stockcollection provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert stockcollection, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for stockcollection")
	}
...
func (o *Stockcollection) DeleteG() error {
	if o == nil {
		return errors.New("models: no Stockcollection provided for deletion")
	}
...
func (o *Stockcollection) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Stockcollection provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from stockcollection")
	}
...
func (q stockcollectionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no stockcollectionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stockcollection")
	}
...
func (o StockcollectionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Stockcollection slice provided for delete all")
	}
...
func (o StockcollectionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stockcollection slice")
	}
...
func (o *Stockcollection) ReloadG() error {
	if o == nil {
		return errors.New("models: no Stockcollection provided for reload")
	}
...
func (o *StockcollectionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StockcollectionSlice provided for reload all")
	}
...
func (o *StockcollectionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in StockcollectionSlice")
	}
...
func StockcollectionExists(exec boil.Executor, stockcollectionID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if stockcollection exists")
	}
