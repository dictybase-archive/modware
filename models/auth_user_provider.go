...
func (q authUserProviderQuery) One() (*AuthUserProvider, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for auth_user_provider")
	}
...
func (q authUserProviderQuery) All() (AuthUserProviderSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to AuthUserProvider slice")
	}
...
func (q authUserProviderQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count auth_user_provider rows")
	}
...
func (q authUserProviderQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if auth_user_provider exists")
	}
...
func FindAuthUserProvider(exec boil.Executor, authUserProviderID int, selectCols ...string) (*AuthUserProvider, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from auth_user_provider")
	}
...
func (o *AuthUserProvider) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no auth_user_provider provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into auth_user_provider")
	}
...
func (o *AuthUserProvider) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update auth_user_provider, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update auth_user_provider row")
	}
...
func (q authUserProviderQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for auth_user_provider")
	}
...
func (o AuthUserProviderSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in authUserProvider slice")
	}
...
func (o *AuthUserProvider) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no auth_user_provider provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert auth_user_provider, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for auth_user_provider")
	}
...
func (o *AuthUserProvider) DeleteG() error {
	if o == nil {
		return errors.New("models: no AuthUserProvider provided for deletion")
	}
...
func (o *AuthUserProvider) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no AuthUserProvider provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from auth_user_provider")
	}
...
func (q authUserProviderQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no authUserProviderQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from auth_user_provider")
	}
...
func (o AuthUserProviderSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no AuthUserProvider slice provided for delete all")
	}
...
func (o AuthUserProviderSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from authUserProvider slice")
	}
...
func (o *AuthUserProvider) ReloadG() error {
	if o == nil {
		return errors.New("models: no AuthUserProvider provided for reload")
	}
...
func (o *AuthUserProviderSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AuthUserProviderSlice provided for reload all")
	}
...
func (o *AuthUserProviderSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in AuthUserProviderSlice")
	}
...
func AuthUserProviderExists(exec boil.Executor, authUserProviderID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if auth_user_provider exists")
	}
