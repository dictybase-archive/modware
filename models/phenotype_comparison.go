...
func (q phenotypeComparisonQuery) One() (*PhenotypeComparison, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for phenotype_comparison")
	}
...
func (q phenotypeComparisonQuery) All() (PhenotypeComparisonSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to PhenotypeComparison slice")
	}
...
func (q phenotypeComparisonQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count phenotype_comparison rows")
	}
...
func (q phenotypeComparisonQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if phenotype_comparison exists")
	}
...
func FindPhenotypeComparison(exec boil.Executor, phenotypeComparisonID int, selectCols ...string) (*PhenotypeComparison, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from phenotype_comparison")
	}
...
func (o *PhenotypeComparison) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotype_comparison provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into phenotype_comparison")
	}
...
func (o *PhenotypeComparison) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update phenotype_comparison, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update phenotype_comparison row")
	}
...
func (q phenotypeComparisonQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for phenotype_comparison")
	}
...
func (o PhenotypeComparisonSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in phenotypeComparison slice")
	}
...
func (o *PhenotypeComparison) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no phenotype_comparison provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert phenotype_comparison, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for phenotype_comparison")
	}
...
func (o *PhenotypeComparison) DeleteG() error {
	if o == nil {
		return errors.New("models: no PhenotypeComparison provided for deletion")
	}
...
func (o *PhenotypeComparison) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no PhenotypeComparison provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from phenotype_comparison")
	}
...
func (q phenotypeComparisonQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no phenotypeComparisonQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotype_comparison")
	}
...
func (o PhenotypeComparisonSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no PhenotypeComparison slice provided for delete all")
	}
...
func (o PhenotypeComparisonSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from phenotypeComparison slice")
	}
...
func (o *PhenotypeComparison) ReloadG() error {
	if o == nil {
		return errors.New("models: no PhenotypeComparison provided for reload")
	}
...
func (o *PhenotypeComparisonSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PhenotypeComparisonSlice provided for reload all")
	}
...
func (o *PhenotypeComparisonSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in PhenotypeComparisonSlice")
	}
...
func PhenotypeComparisonExists(exec boil.Executor, phenotypeComparisonID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if phenotype_comparison exists")
	}
