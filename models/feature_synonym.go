...
func (q featureSynonymQuery) One() (*FeatureSynonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for feature_synonym")
	}
...
func (q featureSynonymQuery) All() (FeatureSynonymSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to FeatureSynonym slice")
	}
...
func (q featureSynonymQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count feature_synonym rows")
	}
...
func (q featureSynonymQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if feature_synonym exists")
	}
...
func FindFeatureSynonym(exec boil.Executor, featureSynonymID int, selectCols ...string) (*FeatureSynonym, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from feature_synonym")
	}
...
func (o *FeatureSynonym) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_synonym provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into feature_synonym")
	}
...
func (o *FeatureSynonym) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update feature_synonym, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update feature_synonym row")
	}
...
func (q featureSynonymQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for feature_synonym")
	}
...
func (o FeatureSynonymSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in featureSynonym slice")
	}
...
func (o *FeatureSynonym) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no feature_synonym provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert feature_synonym, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for feature_synonym")
	}
...
func (o *FeatureSynonym) DeleteG() error {
	if o == nil {
		return errors.New("models: no FeatureSynonym provided for deletion")
	}
...
func (o *FeatureSynonym) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no FeatureSynonym provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from feature_synonym")
	}
...
func (q featureSynonymQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no featureSynonymQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from feature_synonym")
	}
...
func (o FeatureSynonymSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no FeatureSynonym slice provided for delete all")
	}
...
func (o FeatureSynonymSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from featureSynonym slice")
	}
...
func (o *FeatureSynonym) ReloadG() error {
	if o == nil {
		return errors.New("models: no FeatureSynonym provided for reload")
	}
...
func (o *FeatureSynonymSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty FeatureSynonymSlice provided for reload all")
	}
...
func (o *FeatureSynonymSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FeatureSynonymSlice")
	}
...
func FeatureSynonymExists(exec boil.Executor, featureSynonymID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if feature_synonym exists")
	}
