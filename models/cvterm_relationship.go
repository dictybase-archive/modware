...
func (q cvtermRelationshipQuery) One() (*CvtermRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for cvterm_relationship")
	}
...
func (q cvtermRelationshipQuery) All() (CvtermRelationshipSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to CvtermRelationship slice")
	}
...
func (q cvtermRelationshipQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count cvterm_relationship rows")
	}
...
func (q cvtermRelationshipQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if cvterm_relationship exists")
	}
...
func FindCvtermRelationship(exec boil.Executor, cvtermRelationshipID int, selectCols ...string) (*CvtermRelationship, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from cvterm_relationship")
	}
...
func (o *CvtermRelationship) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvterm_relationship provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into cvterm_relationship")
	}
...
func (o *CvtermRelationship) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update cvterm_relationship, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update cvterm_relationship row")
	}
...
func (q cvtermRelationshipQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for cvterm_relationship")
	}
...
func (o CvtermRelationshipSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in cvtermRelationship slice")
	}
...
func (o *CvtermRelationship) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no cvterm_relationship provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert cvterm_relationship, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for cvterm_relationship")
	}
...
func (o *CvtermRelationship) DeleteG() error {
	if o == nil {
		return errors.New("models: no CvtermRelationship provided for deletion")
	}
...
func (o *CvtermRelationship) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no CvtermRelationship provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from cvterm_relationship")
	}
...
func (q cvtermRelationshipQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no cvtermRelationshipQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvterm_relationship")
	}
...
func (o CvtermRelationshipSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no CvtermRelationship slice provided for delete all")
	}
...
func (o CvtermRelationshipSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from cvtermRelationship slice")
	}
...
func (o *CvtermRelationship) ReloadG() error {
	if o == nil {
		return errors.New("models: no CvtermRelationship provided for reload")
	}
...
func (o *CvtermRelationshipSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CvtermRelationshipSlice provided for reload all")
	}
...
func (o *CvtermRelationshipSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CvtermRelationshipSlice")
	}
...
func CvtermRelationshipExists(exec boil.Executor, cvtermRelationshipID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if cvterm_relationship exists")
	}
